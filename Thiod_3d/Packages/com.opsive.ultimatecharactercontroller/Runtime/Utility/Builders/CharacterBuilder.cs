    ...
    public static class CharacterBuilder
    {
        ...
        public static void AddCollider(GameObject character)
        {
            ...
            if (colliderIdentifier == null) {
                ...
                if (Application.isPlaying) {
                    var characterLocomotion = character.GetComponentInParent<CharacterLocomotion>();
                    if (characterLocomotion != null) {
                        characterLocomotion.AddCollider(capsuleCollider);
                    }
                }
            }
        ...
        public static void AddCharacterModel(GameObject character, GameObject model)
        {
            ...
            if (Application.isPlaying) {
                modelManager.ModelIndexMap.Add(model, availableModels.Length - 1);
            }
        }
