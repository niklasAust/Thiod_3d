...
namespace Opsive.UltimateCharacterController.FirstPersonController.Camera.ViewTypes
{
    ...
    {
        /// <summary>
        /// Specifies any extra base rotation.
        /// </summary>
        public enum BaseRotationType
        {
            None,                       // The ViewType has no extra base rotation.
            RotateWithCharacter,        // The ViewType should rotate with the character.
            RotateWithMovingPlatform    // The ViewType should rotate with the moving platform.
        }
        ...
        [SerializeField] protected BaseRotationType m_BaseRotationType;
        ...
        public BaseRotationType RotationType { get { return m_BaseRotationType; } set { m_BaseRotationType = value; } }

        [System.Obsolete("FreeLook.RotateWithCharacter is obsolete. Set the BaseRotationType to RotateWithCharacter instead.")]
        [SerializeField] protected bool m_RotateWithCharacter;
        public bool RotateWithCharacter { get { return m_BaseRotationType == BaseRotationType.RotateWithCharacter; } set { Debug.Log("FreeLook.RotateWithCharacter is obsolete. Set the RotationType to RotateWithCharacter instead."); } }
        ...
        public override Quaternion Rotate(float horizontalMovement, float verticalMovement, bool immediatePosition)
        {
            ...
            if (m_BaseRotationType == BaseRotationType.RotateWithCharacter) {
                m_BaseRotation = m_CharacterLocomotion.Rotation;
            } else if (m_BaseRotationType == BaseRotationType.RotateWithMovingPlatform && m_CharacterLocomotion.MovingPlatform!= null) {
                m_BaseRotation = m_CharacterLocomotion.MovingPlatform.rotation;
            }
