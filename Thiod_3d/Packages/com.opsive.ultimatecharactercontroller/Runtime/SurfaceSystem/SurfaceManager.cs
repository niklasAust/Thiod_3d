...
namespace Opsive.UltimateCharacterController.SurfaceSystem
{
    ...
    public class SurfaceManager : MonoBehaviour
    {
        ...
        public SurfaceEffect GetSurfaceEffect(RaycastHit hit, Collider hitCollider, SurfaceImpact surfaceImpact, ref SurfaceType surfaceType, ref bool spawnDecals)
        {
        ...
        public SurfaceType GetSurfaceType(RaycastHit hit, Collider hitCollider)
        {
        ...
        public SurfaceIdentifier GetSurfaceIdentifier(Collider hitCollider)
        {
