...
namespace AmazingAssets.LowpolyStyleMeshGenerator.Editor
{
    ...
    public class ReadMeEditor : UnityEditor.Editor
    {
        ...
        protected override void OnHeaderGUI()
        {
            ...
            GUILayout.BeginHorizontal("In BigTitle");
            {
                ...
                GUILayout.BeginVertical();
                {
                    ...
                    GUILayout.Label(LowpolyStyleMeshGeneratorAbout.name, GUIStyleTitle);
                    GUILayout.Label("Version " + LowpolyStyleMeshGeneratorAbout.version, EditorStyles.centeredGreyMiniLabel);
                    GUILayout.FlexibleSpace();
                }
        ...
        {
            string fileName = "AmazingAssets.LowpolyStyleMeshGenerator.Editor";
