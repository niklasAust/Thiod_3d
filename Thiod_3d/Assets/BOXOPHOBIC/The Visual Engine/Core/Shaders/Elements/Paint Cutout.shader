// Upgrade NOTE: upgraded instancing buffer 'BOXOPHOBICTheVisualEngineElementsPaintCutout' to new syntax.

// Made with Amplify Shader Editor v1.9.9.8
// Available at the Unity Asset Store - http://u3d.as/y3X 
Shader "BOXOPHOBIC/The Visual Engine/Elements/Paint Cutout"
{
	Properties
	{
	...
	LOD 100
		...
		Pass
		{
			...
			#pragma target 3.0
			ENDCG
			Blend [_render_src] [_render_dst], [_render_src] [_render_dst]
			AlphaToMask Off
			Cull Back
			ColorMask A
			ZWrite Off
			...
			UNITY_INSTANCING_BUFFER_START(BOXOPHOBICTheVisualEngineElementsPaintCutout)
				UNITY_DEFINE_INSTANCED_PROP(half4, _ElementParams)
#define _ElementParams_arr BOXOPHOBICTheVisualEngineElementsPaintCutout
			UNITY_INSTANCING_BUFFER_END(BOXOPHOBICTheVisualEngineElementsPaintCutout)
			...
			v2f vert ( appdata v )
			{
				...
				half smoothstepResult2286_g76908 = smoothstep( 0.0 , 1.0 , saturate( ( temp_output_9_0_g77044 * _SeasonRemap.z ) ));
				half SeasonLerp54_g76908 = smoothstepResult2286_g76908;
				half lerpResult168_g76908 = lerp( Value_Winter158_g76908 , Value_Spring159_g76908 , SeasonLerp54_g76908);
				half TVE_SeasonOptions_Y51_g76908 = TVE_SeasonOption.y;
				half Value_Summer160_g76908 = _AdditionalValue3;
				half lerpResult167_g76908 = lerp( Value_Spring159_g76908 , Value_Summer160_g76908 , SeasonLerp54_g76908);
				half TVE_SeasonOptions_Z52_g76908 = TVE_SeasonOption.z;
				half Value_Autumn161_g76908 = _AdditionalValue4;
				half lerpResult166_g76908 = lerp( Value_Summer160_g76908 , Value_Autumn161_g76908 , SeasonLerp54_g76908);
				half TVE_SeasonOptions_W53_g76908 = TVE_SeasonOption.w;
				half lerpResult165_g76908 = lerp( Value_Autumn161_g76908 , Value_Winter158_g76908 , SeasonLerp54_g76908);
				half temp_output_175_0_g76908 = ( ( TVE_SeasonOptions_X50_g76908 * lerpResult168_g76908 ) + ( TVE_SeasonOptions_Y51_g76908 * lerpResult167_g76908 ) + ( TVE_SeasonOptions_Z52_g76908 * lerpResult166_g76908 ) + ( TVE_SeasonOptions_W53_g76908 * lerpResult165_g76908 ) );
				half vertexToFrag11_g76972 = temp_output_175_0_g76908;
				o.ase_texcoord1.x = vertexToFrag11_g76972;
				float3 ase_positionWS = mul( unity_ObjectToWorld, float4( ( v.vertex ).xyz, 1 ) ).xyz;
				half2 appendResult1900_g76908 = (half2(ase_positionWS.x , ase_positionWS.z));
				half2 lerpResult1899_g76908 = lerp( ( 1.0 - v.ase_texcoord.xy ) , appendResult1900_g76908 , _ElementUVsMode);
				half2 vertexToFrag11_g77047 = ( ( lerpResult1899_g76908 * (_MainUVs).xy ) + (_MainUVs).zw );
				o.ase_texcoord1.yz = vertexToFrag11_g77047;
				half2 appendResult60_g76914 = (half2(ase_positionWS.x , ase_positionWS.z));
				half2 lerpResult58_g76914 = lerp( ( 1.0 - v.ase_texcoord.xy ) , appendResult60_g76914 , _ElementMaskCoordMode);
				half2 vertexToFrag11_g76917 = ( ( lerpResult58_g76914 * (_ElementMaskCoordValue).xy ) + (_ElementMaskCoordValue).zw );
				o.ase_texcoord2.zw = vertexToFrag11_g76917;
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half lerpResult181_g76908 = lerp( Value_Main157_g76908 , Value_Seasons1721_g76908 , Element_Mode55_g76908);
				half2 vertexToFrag11_g77047 = i.ase_texcoord1.yz;
				half4 MainTex_RGBA587_g76908 = tex2D( _MainTex, vertexToFrag11_g77047 );
				half3 temp_output_6_0_g77050 = (MainTex_RGBA587_g76908).rgb;
				half SpaceTexture2395_g76908 = _SpaceTexture;
				half temp_output_7_0_g77050 = SpaceTexture2395_g76908;
				#ifdef TVE_DUMMY
				...
				half3 temp_output_1765_0_g76908 = saturate( ( temp_output_9_0_g77048 * _MainTexColorRemap.z ) );
				...
				half temp_output_468_0_g76908 = ( lerpResult181_g76908 * Element_Value1744_g76908 );
				half Extras_RGB2401_g76908 = temp_output_468_0_g76908;
				half temp_output_6_0_g77051 = (MainTex_RGBA587_g76908).a;
				half temp_output_7_0_g77051 = SpaceTexture2395_g76908;
				#ifdef TVE_DUMMY
				...
				half temp_output_7_0_g77053 = SpaceTexture2395_g76908;
				#ifdef TVE_DUMMY
				...
				#endif
				half2 vertexToFrag11_g76917 = i.ase_texcoord2.zw;
				half4 MainTex_RGBA53_g76914 = tex2D( _ElementMaskTex, vertexToFrag11_g76917 );
				half lerpResult148_g76914 = lerp( (MainTex_RGBA53_g76914).r , (MainTex_RGBA53_g76914).a , _ElementMaskMode);
				half clampResult17_g76923 = clamp( lerpResult148_g76914 , 0.0001 , 0.9999 );
				half temp_output_7_0_g76924 = _ElementMaskRemap.x;
				half temp_output_9_0_g76924 = ( clampResult17_g76923 - temp_output_7_0_g76924 );
				half lerpResult73_g76914 = lerp( 1.0 , saturate( ( temp_output_9_0_g76924 * _ElementMaskRemap.z ) ) , _ElementMaskValue);
				half Blend_Mask45_g76914 = lerpResult73_g76914;
				half3 ase_normalWS = i.ase_texcoord3.xyz;
				half4 appendResult108_g76914 = (half4(_TerrainPosition.x , _TerrainPosition.z , _TerrainSize.x , _TerrainSize.z));
				half4 Terrain_Coords111_g76914 = appendResult108_g76914;
				half4 temp_output_35_0_g76922 = Terrain_Coords111_g76914;
				...
				half2 temp_output_65_0_g76922 = ( ( (WorldPosition).xz * FinalScale53_g76922 ) + FinalPosition58_g76922 );
				half Terrain_InputMode136_g76914 = _TerrainInputMode;
				half3 lerpResult141_g76914 = lerp( ase_normalWS , tex2D( _TerrainNormalTex, temp_output_65_0_g76922 ).rgb , Terrain_InputMode136_g76914);
				half3 Terrain_Normal107_g76914 = lerpResult141_g76914;
				half dotResult113_g76914 = dot( Terrain_Normal107_g76914 , half3( 0, 1, 0 ) );
				half clampResult17_g76919 = clamp( dotResult113_g76914 , 0.0001 , 0.9999 );
				half temp_output_7_0_g76920 = _ElementProjRemap.x;
				half temp_output_9_0_g76920 = ( clampResult17_g76919 - temp_output_7_0_g76920 );
				half lerpResult123_g76914 = lerp( 1.0 , saturate( ( temp_output_9_0_g76920 * _ElementProjRemap.z ) ) , _ElementProjValue);
				half Blend_Proj117_g76914 = lerpResult123_g76914;
				half4 temp_output_35_0_g76915 = Terrain_Coords111_g76914;
				float2 InputScale48_g76915 = (temp_output_35_0_g76915).zw;
				half2 FinalScale53_g76915 = ( 1.0 / InputScale48_g76915 );
				float2 InputPosition52_g76915 = (temp_output_35_0_g76915).xy;
				half2 FinalPosition58_g76915 = -( FinalScale53_g76915 * InputPosition52_g76915 );
				half2 temp_output_65_0_g76915 = ( ( (WorldPosition).xz * FinalScale53_g76915 ) + FinalPosition58_g76915 );
				half4 temp_output_70_0_g76915 = _TerrainHeightTex_TexelSize;
				float2 InputTexelSize68_g76915 = (temp_output_70_0_g76915).zw;
				half2 temp_cast_3 = (1.0).xx;
				float2 InputTexelRecip69_g76915 = (temp_output_70_0_g76915).xy;
				float4 Terrain_Height_Raw104_g76914 = tex2D( _TerrainHeightTex, ( ( ( temp_output_65_0_g76915 / ( 1.0 / ( InputTexelSize68_g76915 - temp_cast_3 ) ) ) + 0.5 ) * InputTexelRecip69_g76915 ) );
				half temp_output_90_0_g76914 = ( ( (Terrain_Height_Raw104_g76914).r + ( (Terrain_Height_Raw104_g76914).g * 256.0 ) ) / 257.0 );
				#ifdef SHADER_API_VULKAN
				half staticSwitch91_g76914 = temp_output_90_0_g76914;
				#else
				half staticSwitch91_g76914 = (Terrain_Height_Raw104_g76914).r;
				#endif
				#ifdef SHADER_API_GLES
				half staticSwitch92_g76914 = temp_output_90_0_g76914;
				#else
				half staticSwitch92_g76914 = staticSwitch91_g76914;
				#endif
				#ifdef SHADER_API_GLES3
				half staticSwitch93_g76914 = temp_output_90_0_g76914;
				#else
				half staticSwitch93_g76914 = staticSwitch92_g76914;
				#endif
				float Terrain_Height_Platform105_g76914 = staticSwitch93_g76914;
				half Terrain_SizeY109_g76914 = _TerrainSize.y;
				half Terrain_PosY110_g76914 = _TerrainPosition.y;
				half lerpResult137_g76914 = lerp( WorldPosition.y , ( ( Terrain_Height_Platform105_g76914 * Terrain_SizeY109_g76914 * 2.0 ) + Terrain_PosY110_g76914 ) , Terrain_InputMode136_g76914);
				float Terrain_Height106_g76914 = lerpResult137_g76914;
				half temp_output_7_0_g76921 = _ElementPosMaxValue;
				half temp_output_9_0_g76921 = ( Terrain_Height106_g76914 - temp_output_7_0_g76921 );
				half lerpResult129_g76914 = lerp( 1.0 , saturate( ( temp_output_9_0_g76921 / ( ( _ElementPosMinValue - temp_output_7_0_g76921 ) + 0.0001 ) ) ) , _ElementPosValue);
				half Blend_Pos131_g76914 = lerpResult129_g76914;
				half temp_output_6_0_g76925 = ( Blend_Mask45_g76914 * Blend_Proj117_g76914 * Blend_Pos131_g76914 );
				half Dummy144_g76914 = ( _MaskingCategory + _MaskingEnd + ( _MaskingTerrainInfo + _MaskingModelInfo ) );
				half temp_output_7_0_g76925 = Dummy144_g76914;
				#ifdef TVE_DUMMY
				half staticSwitch14_g76925 = ( temp_output_6_0_g76925 + temp_output_7_0_g76925 );
				#else
				half staticSwitch14_g76925 = temp_output_6_0_g76925;
				#endif
				...
				#endif
				half Element_Alpha56_g76908 = ( _ElementIntensity * Element_Remap_A74_g76908 * Element_Params_A1737_g76908 * i.ase_color.a * Element_Falloff1883_g76908 * staticSwitch14_g76930 * staticSwitch14_g76925 * staticSwitch14_g76982 );
				half lerpResult1634_g76908 = lerp( 1.0 , Extras_RGB2401_g76908 , Element_Alpha56_g76908);
				half Element_BlendA918_g76908 = _ElementBlendA;
				half lerpResult933_g76908 = lerp( lerpResult1634_g76908 , ( Extras_RGB2401_g76908 * Element_Alpha56_g76908 ) , Element_BlendA918_g76908);
				half Final_Blend_AOnly211_g76908 = lerpResult933_g76908;
				half4 appendResult475_g76908 = (half4(0.0 , 0.0 , 0.0 , Final_Blend_AOnly211_g76908));
...
#define _ElementParams_arr BOXOPHOBICTheVisualEngineElementsPaintCutout
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half Element_Value1744_g76908 = ( Element_Remap_R73_g76908 * Element_Params_R1738_g76908 * i.ase_color.r );
				half temp_output_468_0_g76908 = ( lerpResult181_g76908 * Element_Value1744_g76908 );
				half3 appendResult2402_g76908 = (half3(temp_output_468_0_g76908 , temp_output_468_0_g76908 , temp_output_468_0_g76908));
				...
				half4 appendResult2468_g76908 = (half4(FInal_RGB213_g76908 , Final_A241_g76908));
				...
				half3 Input_Tint76_g77283 = color158;
