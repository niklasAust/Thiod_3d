// Upgrade NOTE: upgraded instancing buffer 'HiddenBOXOPHOBICTheVisualEngineElementsMotionTurbulence' to new syntax.

// Made with Amplify Shader Editor v1.9.9.4
// Available at the Unity Asset Store - http://u3d.as/y3X 
Shader "Hidden/BOXOPHOBIC/The Visual Engine/Elements/Motion Turbulence"
{
	Properties
	{
		...
		[Enum(Multiply,0,Additive,1,Blended,2)] _ElementBlendRGB( "Render Blend", Float ) = 2
	...
	LOD 0
		...
		Pass
		{
			...
			CGPROGRAM
				...
				uniform half _ElementBlendRGB;
				UNITY_INSTANCING_BUFFER_START(HiddenBOXOPHOBICTheVisualEngineElementsMotionTurbulence)
					UNITY_DEFINE_INSTANCED_PROP(half4, _ElementParams)
#define _ElementParams_arr HiddenBOXOPHOBICTheVisualEngineElementsMotionTurbulence
				UNITY_INSTANCING_BUFFER_END(HiddenBOXOPHOBICTheVisualEngineElementsMotionTurbulence)
				...
				v2f vert ( appdata v )
				{
					...
					float2 appendResult1900_g21482 = (float2(ase_positionWS.x , ase_positionWS.z));
					float2 lerpResult1899_g21482 = lerp( ( 1.0 - v.ase_texcoord.xy ) , appendResult1900_g21482 , _ElementUVsMode);
					float2 vertexToFrag11_g22417 = ( ( lerpResult1899_g21482 * (_MainUVs).xy ) + (_MainUVs).zw );
					o.ase_texcoord.xy = vertexToFrag11_g22417;
					...
					o.ase_texcoord2.xy = vertexToFrag11_g76915;
				...
				half4 frag( v2f IN  ) : SV_Target
				{
					...
					float2 vertexToFrag11_g22417 = IN.ase_texcoord.xy;
					half4 MainTex_RGBA587_g21482 = tex2D( _MainTex, vertexToFrag11_g22417 );
					float3 temp_cast_0 = (0.0001).xxx;
					float3 temp_cast_1 = (0.9999).xxx;
					float3 clampResult17_g22408 = clamp( (MainTex_RGBA587_g21482).rgb , temp_cast_0 , temp_cast_1 );
					float temp_output_7_0_g76931 = _MainTexColorRemap.x;
					float3 temp_cast_2 = (temp_output_7_0_g76931).xxx;
					float3 temp_output_9_0_g76931 = ( clampResult17_g22408 - temp_cast_2 );
					float3 temp_output_1765_0_g21482 = saturate( ( temp_output_9_0_g76931 * _MainTexColorRemap.z ) );
					...
					float2 lerpResult1471_g21482 = lerp( Direction_Texture284_g21482 , -Direction_Texture284_g21482 , Element_InvertMode489_g21482);
					float3 appendResult292_g21482 = (float3(lerpResult1471_g21482 , 0.0));
					half3 Final_MotionInteraction_RGB303_g21482 = appendResult292_g21482;
					float clampResult17_g22409 = clamp( (MainTex_RGBA587_g21482).a , 0.0001 , 0.9999 );
					float temp_output_7_0_g76932 = _MainTexAlphaRemap.x;
					float temp_output_9_0_g76932 = ( clampResult17_g22409 - temp_output_7_0_g76932 );
					half Element_Remap_A74_g21482 = saturate( ( ( temp_output_9_0_g76932 * _MainTexAlphaRemap.z ) + 0.0001 ) );
					half4 _ElementParams_Instance = UNITY_ACCESS_INSTANCED_PROP(_ElementParams_arr, _ElementParams);
					half Element_Params_A1737_g21482 = _ElementParams_Instance.w;
					float clampResult17_g21978 = clamp( saturate( ( 1.0 - distance( (IN.ase_texcoord.zw*2.0 + -1.0) , float2( 0,0 ) ) ) ) , 0.0001 , 0.9999 );
					float temp_output_7_0_g76935 = _MainTexFalloffRemap.x;
					float temp_output_9_0_g76935 = ( clampResult17_g21978 - temp_output_7_0_g76935 );
					half Element_Falloff1883_g21482 = saturate( ( ( temp_output_9_0_g76935 * _MainTexFalloffRemap.z ) + 0.0001 ) );
					...
					#endif
					float2 vertexToFrag11_g76915 = IN.ase_texcoord2.xy;
					...
					float4 Terrain_Height_Raw104_g76912 = tex2D( _TerrainHeightTex, ( ( ( temp_output_65_0_g76913 / ( 1.0 / ( InputTexelSize68_g76913 - temp_cast_5 ) ) ) + 0.5 ) * InputTexelRecip69_g76913 ) );
					...
					#endif
					half Element_Alpha56_g21482 = ( _ElementIntensity * Element_Remap_A74_g21482 * Element_Params_A1737_g21482 * IN.ase_color.a * Element_Falloff1883_g21482 * staticSwitch14_g76930 * staticSwitch14_g76923 );
					half Final_MotionInteraction_A305_g21482 = Element_Alpha56_g21482;
					float temp_output_6_0_g76952 = Final_MotionInteraction_A305_g21482;
					half Element_BlendRGB1631_g21482 = _ElementBlendRGB;
					#ifdef TVE_DUMMY
					float staticSwitch14_g76952 = ( temp_output_6_0_g76952 + Element_BlendRGB1631_g21482 );
					#else
					float staticSwitch14_g76952 = temp_output_6_0_g76952;
					#endif
					float4 appendResult479_g21482 = (float4(Final_MotionInteraction_RGB303_g21482 , staticSwitch14_g76952));
					

					finalColor = appendResult479_g21482;
...
/*ASEBEGIN
Version=19904
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;197;-640,-1152;Half;False;Property;_render_colormask;_render_colormask;97;1;[HideInInspector];Create;True;0;0;0;True;0;False;15;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;177;-640,-1280;Inherit;False;Element Base Motion;-1;;20879;;0;0;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;95;-352,-1280;Half;False;Property;_Banner;Banner;0;0;Create;True;0;0;0;True;1;StyledBanner(Motion Turbulence Element);False;0;0;1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;115;-224,-1280;Half;False;Property;_Message;Message;1;0;Create;True;0;0;0;True;1;StyledMessage(Info, Use the Motion Turbulence elements to add noise to the motion direction. Element Texture A is used as alpha mask. Particle Alpha is used as Element Intensity multiplier. The noise is animated in the element forward direction and it is updated with particles or in play mode only., 0,0);False;0;0;1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;281;-640,-1024;Inherit;False;Element Shader;2;;21482;0e972c73cae2ee54ea51acc9738801d0;14,1778,2,477,2,478,0,1824,0,1814,3,145,3,1784,2,481,2,1935,1,1933,1,1904,1,1907,1,2310,1,2311,1;1;1974;FLOAT;0;False;2;FLOAT4;0;FLOAT4;1779
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;0;-320,-1024;Float;False;True;-1;2;OOShaderGUIElement;0;5;Hidden/BOXOPHOBIC/The Visual Engine/Elements/Motion Turbulence;0770190933193b94aaa3065e307002fa;True;Unlit;0;0;Unlit;2;True;True;2;5;False;;10;False;;4;1;False;;1;False;;True;0;False;;0;False;;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;2;False;;True;True;True;True;True;True;0;False;_render_colormask;False;False;False;False;False;False;False;True;False;255;False;;255;False;;255;False;;7;False;;1;False;;1;False;;1;False;;7;False;;1;False;;1;False;;1;False;;False;True;2;False;;True;0;False;;True;False;0;False;;0;False;;True;4;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;PreviewType=Plane;DisableBatching=True=DisableBatching;True;2;False;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;0;;0;0;Standard;1;Vertex Position;1;0;0;1;True;False;;False;0
WireConnection;0;0;281;0
ASEEND*/
//CHKSM=E8C9E6D27F0C293F5D08813A9D0709CA51D821F8