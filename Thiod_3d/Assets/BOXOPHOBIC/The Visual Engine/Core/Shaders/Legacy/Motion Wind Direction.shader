...
#define _ElementParams_arr HiddenBOXOPHOBICTheVisualEngineElementsMotionWindDirection
				...
				v2f vert ( appdata v )
				{
					...
					float smoothstepResult2286_g53336 = smoothstep( 0.0 , 1.0 , saturate( ( temp_output_9_0_g76933 * _SeasonRemap.z ) ));
					half TVE_SeasonLerp54_g53336 = smoothstepResult2286_g53336;
					...
					float vertexToFrag11_g76925 = ( ( TVE_SeasonOptions_X50_g53336 * lerpResult168_g53336 ) + ( TVE_SeasonOptions_Y51_g53336 * lerpResult167_g53336 ) + ( TVE_SeasonOptions_Z52_g53336 * lerpResult166_g53336 ) + ( TVE_SeasonOptions_W53_g53336 * lerpResult165_g53336 ) );
					o.ase_texcoord.x = vertexToFrag11_g76925;
					float3 ase_positionWS = mul( unity_ObjectToWorld, float4( ( v.vertex ).xyz, 1 ) ).xyz;
					float2 appendResult1900_g53336 = (float2(ase_positionWS.x , ase_positionWS.z));
					float2 lerpResult1899_g53336 = lerp( ( 1.0 - v.ase_texcoord.xy ) , appendResult1900_g53336 , _ElementUVsMode);
					float2 vertexToFrag11_g53340 = ( ( lerpResult1899_g53336 * (_MainUVs).xy ) + (_MainUVs).zw );
					o.ase_texcoord.yz = vertexToFrag11_g53340;
				...
				half4 frag( v2f IN  ) : SV_Target
				{
					...
					half Value_Seasons1721_g53336 = vertexToFrag11_g76925;
					...
					float2 vertexToFrag11_g53340 = IN.ase_texcoord.yz;
					half4 MainTex_RGBA587_g53336 = tex2D( _MainTex, vertexToFrag11_g53340 );
					float3 temp_cast_0 = (0.0001).xxx;
					float3 temp_cast_1 = (0.9999).xxx;
					float3 clampResult17_g53338 = clamp( (MainTex_RGBA587_g53336).rgb , temp_cast_0 , temp_cast_1 );
					float temp_output_7_0_g76931 = _MainTexColorRemap.x;
					float3 temp_cast_2 = (temp_output_7_0_g76931).xxx;
					float3 temp_output_9_0_g76931 = ( clampResult17_g53338 - temp_cast_2 );
					float3 temp_output_1765_0_g53336 = saturate( ( temp_output_9_0_g76931 * _MainTexColorRemap.z ) );
					...
					half Element_Value1744_g53336 = ( Element_Remap_R73_g53336 * Element_Params_R1738_g53336 * IN.ase_color.r );
					half Final_Extras_RGB213_g53336 = ( lerpResult181_g53336 * Element_Value1744_g53336 );
					float clampResult17_g53339 = clamp( (MainTex_RGBA587_g53336).a , 0.0001 , 0.9999 );
					float temp_output_7_0_g76932 = _MainTexAlphaRemap.x;
					float temp_output_9_0_g76932 = ( clampResult17_g53339 - temp_output_7_0_g76932 );
					half Element_Remap_A74_g53336 = saturate( ( ( temp_output_9_0_g76932 * _MainTexAlphaRemap.z ) + 0.0001 ) );
					half Element_Params_A1737_g53336 = _ElementParams_Instance.w;
					float clampResult17_g53337 = clamp( saturate( ( 1.0 - distance( (IN.ase_texcoord1.xy*2.0 + -1.0) , float2( 0,0 ) ) ) ) , 0.0001 , 0.9999 );
					float temp_output_7_0_g76935 = _MainTexFalloffRemap.x;
					float temp_output_9_0_g76935 = ( clampResult17_g53337 - temp_output_7_0_g76935 );
					half Element_Falloff1883_g53336 = saturate( ( ( temp_output_9_0_g76935 * _MainTexFalloffRemap.z ) + 0.0001 ) );
					...
					#endif
					half Element_Alpha56_g53336 = ( _ElementIntensity * Element_Remap_A74_g53336 * Element_Params_A1737_g53336 * IN.ase_color.a * Element_Falloff1883_g53336 * staticSwitch14_g76930 * staticSwitch14_g76923 );
					float lerpResult1634_g53336 = lerp( 1.0 , Final_Extras_RGB213_g53336 , Element_Alpha56_g53336);
					half Element_BlendA918_g53336 = _ElementBlendA;
					float lerpResult933_g53336 = lerp( lerpResult1634_g53336 , ( Final_Extras_RGB213_g53336 * Element_Alpha56_g53336 ) , Element_BlendA918_g53336);
					half Final_Blend_A211_g53336 = lerpResult933_g53336;
					float4 appendResult1732_g53336 = (float4(0.0 , 0.0 , 0.0 , Final_Blend_A211_g53336));
...
/*ASEBEGIN
Version=19904
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;95;-384,-1280;Half;False;Property;_Banner;Banner;0;0;Create;True;0;0;0;True;1;StyledBanner(Motion Direction Element);False;0;0;1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;199;-640,-1024;Inherit;False;Element Shader;2;;53336;0e972c73cae2ee54ea51acc9738801d0;14,1778,2,477,2,478,0,1824,0,1814,3,145,3,1784,0,481,0,1935,1,1933,1,1904,1,1907,1,2310,1,2311,1;1;1974;FLOAT;0;False;2;FLOAT4;0;FLOAT4;1779
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;0;-304,-1024;Float;False;True;-1;2;OOShaderGUIElement;0;5;Hidden/BOXOPHOBIC/The Visual Engine/Elements/Motion Wind Direction;0770190933193b94aaa3065e307002fa;True;Unlit;0;0;Unlit;2;False;True;2;5;False;;10;False;;0;1;False;;0;False;;True;0;False;;0;False;;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;2;False;;True;True;True;True;False;False;0;False;;False;False;False;False;False;False;False;True;False;255;False;;255;False;;255;False;;7;False;;1;False;;1;False;;1;False;;7;False;;1;False;;1;False;;1;False;;False;True;2;False;;True;0;False;;True;False;0;False;;0;False;;True;4;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;PreviewType=Plane;DisableBatching=True=DisableBatching;True;2;False;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;0;;0;0;Standard;1;Vertex Position;1;0;0;1;True;False;;False;0
WireConnection;0;0;199;0
ASEEND*/
//CHKSM=89709E43B8498942C5B5A0413DC0FA7A9E980C20