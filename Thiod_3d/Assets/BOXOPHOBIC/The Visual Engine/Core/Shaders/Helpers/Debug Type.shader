		...
		Pass
		{
			...
			CGPROGRAM
				...
				v2f VertexFunction( appdata v  )
				{
					...
					TVEModelData Data16_g240719 =(TVEModelData)0;
					half Dummy207_g240709 = ( _ObjectCategory + _ObjectEnd + _ObjectModelMode + _ObjectPivotMode );
					float temp_output_14_0_g240719 = Dummy207_g240709;
					float In_Dummy16_g240719 = temp_output_14_0_g240719;
					float3 PositionOS131_g240709 = v.vertex.xyz;
					float3 temp_output_4_0_g240719 = PositionOS131_g240709;
					float3 In_PositionOS16_g240719 = temp_output_4_0_g240719;
					float3 ase_positionWS = mul( unity_ObjectToWorld, float4( ( v.vertex ).xyz, 1 ) ).xyz;
					float3 temp_output_104_7_g240709 = ase_positionWS;
					float3 vertexToFrag73_g240709 = temp_output_104_7_g240709;
					float3 PositionWS122_g240709 = vertexToFrag73_g240709;
					float3 In_PositionWS16_g240719 = PositionWS122_g240709;
					float4x4 break19_g240712 = unity_ObjectToWorld;
					float3 appendResult20_g240712 = (float3(break19_g240712[ 0 ][ 3 ] , break19_g240712[ 1 ][ 3 ] , break19_g240712[ 2 ][ 3 ]));
					float3 temp_output_340_7_g240709 = appendResult20_g240712;
					float4x4 break19_g240714 = unity_ObjectToWorld;
					float3 appendResult20_g240714 = (float3(break19_g240714[ 0 ][ 3 ] , break19_g240714[ 1 ][ 3 ] , break19_g240714[ 2 ][ 3 ]));
					float3 _Vector0 = float3(0,0,0);
					float3 appendResult60_g240710 = (float3(v.ase_texcoord3.x , v.ase_texcoord3.z , v.ase_texcoord3.y));
					float3 break233_g240709 = PositionOS131_g240709;
					float3 appendResult234_g240709 = (float3(break233_g240709.x , 0.0 , break233_g240709.z));
					float3 break413_g240709 = PositionOS131_g240709;
					float3 appendResult414_g240709 = (float3(break413_g240709.x , break413_g240709.y , 0.0));
					#ifdef TVE_COORD_ZUP
					float3 staticSwitch65_g240716 = appendResult414_g240709;
					#else
					float3 staticSwitch65_g240716 = appendResult234_g240709;
					#endif
					#if defined( TVE_PIVOT_SINGLE )
					float3 staticSwitch229_g240709 = _Vector0;
					#elif defined( TVE_PIVOT_BAKED )
					float3 staticSwitch229_g240709 = appendResult60_g240710;
					#elif defined( TVE_PIVOT_PROC )
					float3 staticSwitch229_g240709 = staticSwitch65_g240716;
					#else
					float3 staticSwitch229_g240709 = _Vector0;
					#endif
					float3 PivotOS149_g240709 = staticSwitch229_g240709;
					float3 temp_output_122_0_g240714 = PivotOS149_g240709;
					float3 PivotsOnlyWS105_g240714 = mul( unity_ObjectToWorld, float4( temp_output_122_0_g240714 , 0.0 ) ).xyz;
					float3 temp_output_341_7_g240709 = ( appendResult20_g240714 + PivotsOnlyWS105_g240714 );
					#if defined( TVE_PIVOT_SINGLE )
					float3 staticSwitch236_g240709 = temp_output_340_7_g240709;
					#elif defined( TVE_PIVOT_BAKED )
					float3 staticSwitch236_g240709 = temp_output_341_7_g240709;
					#elif defined( TVE_PIVOT_PROC )
					float3 staticSwitch236_g240709 = temp_output_341_7_g240709;
					#else
					float3 staticSwitch236_g240709 = temp_output_340_7_g240709;
					#endif
					float3 vertexToFrag76_g240709 = staticSwitch236_g240709;
					float3 PivotWS121_g240709 = vertexToFrag76_g240709;
					#ifdef TVE_SCOPE_DYNAMIC
					float3 staticSwitch204_g240709 = ( PositionWS122_g240709 - PivotWS121_g240709 );
					#else
					float3 staticSwitch204_g240709 = PositionWS122_g240709;
					#endif
					float3 PositionWO132_g240709 = ( staticSwitch204_g240709 - TVE_WorldOrigin );
					float3 In_PositionWO16_g240719 = PositionWO132_g240709;
					float3 In_PositionRawOS16_g240719 = PositionOS131_g240709;
					float3 In_PivotOS16_g240719 = PivotOS149_g240709;
					float3 In_PivotWS16_g240719 = PivotWS121_g240709;
					float3 PivotWO133_g240709 = ( PivotWS121_g240709 - TVE_WorldOrigin );
					float3 In_PivotWO16_g240719 = PivotWO133_g240709;
					half3 NormalOS134_g240709 = v.normal;
					float3 temp_output_21_0_g240719 = NormalOS134_g240709;
					float3 In_NormalOS16_g240719 = temp_output_21_0_g240719;
					float3 ase_normalWS = UnityObjectToWorldNormal( v.normal );
					float3 normalizedWorldNormal = normalize( ase_normalWS );
					half3 NormalWS95_g240709 = normalizedWorldNormal;
					float3 In_NormalWS16_g240719 = NormalWS95_g240709;
					float3 In_NormalRawOS16_g240719 = NormalOS134_g240709;
					half4 TangentlOS153_g240709 = v.tangent;
					float4 temp_output_6_0_g240719 = TangentlOS153_g240709;
					float4 In_TangentOS16_g240719 = temp_output_6_0_g240719;
					float3 ase_tangentWS = UnityObjectToWorldDir( v.tangent );
					half3 TangentWS136_g240709 = ase_tangentWS;
					float3 In_TangentWS16_g240719 = TangentWS136_g240709;
					float ase_tangentSign = v.tangent.w * ( unity_WorldTransformParams.w >= 0.0 ? 1.0 : -1.0 );
					float3 ase_bitangentWS = cross( ase_normalWS, ase_tangentWS ) * ase_tangentSign;
					half3 BiangentWS421_g240709 = ase_bitangentWS;
					float3 In_BitangentWS16_g240719 = BiangentWS421_g240709;
					float3 normalizeResult296_g240709 = normalize( ( _WorldSpaceCameraPos - PositionWS122_g240709 ) );
					half3 ViewDirWS169_g240709 = normalizeResult296_g240709;
					float3 In_ViewDirWS16_g240719 = ViewDirWS169_g240709;
					float4 appendResult397_g240709 = (float4(v.texcoord.xyzw.xy , v.texcoord2.xyzw.xy));
					float4 CoordsData398_g240709 = appendResult397_g240709;
					float4 In_CoordsData16_g240719 = CoordsData398_g240709;
					half4 VertexMasks171_g240709 = v.ase_color;
					float4 In_VertexData16_g240719 = VertexMasks171_g240709;
					#ifdef TVE_COORD_ZUP
					float staticSwitch65_g240722 = (PositionOS131_g240709).z;
					#else
					float staticSwitch65_g240722 = (PositionOS131_g240709).y;
					#endif
					half Object_HeightValue267_g240709 = _ObjectHeightValue;
					half Bounds_HeightMask274_g240709 = saturate( ( staticSwitch65_g240722 / Object_HeightValue267_g240709 ) );
					half3 Position387_g240709 = PositionOS131_g240709;
					half Height387_g240709 = Object_HeightValue267_g240709;
					half Object_RadiusValue268_g240709 = _ObjectRadiusValue;
					half Radius387_g240709 = Object_RadiusValue268_g240709;
					half localCapsuleMaskYUp387_g240709 = CapsuleMaskYUp( Position387_g240709 , Height387_g240709 , Radius387_g240709 );
					half3 Position408_g240709 = PositionOS131_g240709;
					half Height408_g240709 = Object_HeightValue267_g240709;
					half Radius408_g240709 = Object_RadiusValue268_g240709;
					half localCapsuleMaskZUp408_g240709 = CapsuleMaskZUp( Position408_g240709 , Height408_g240709 , Radius408_g240709 );
					#ifdef TVE_COORD_ZUP
					float staticSwitch65_g240727 = saturate( localCapsuleMaskZUp408_g240709 );
					#else
					float staticSwitch65_g240727 = saturate( localCapsuleMaskYUp387_g240709 );
					#endif
					half Bounds_SphereMask282_g240709 = staticSwitch65_g240727;
					float4 appendResult253_g240709 = (float4(Bounds_HeightMask274_g240709 , Bounds_SphereMask282_g240709 , 1.0 , 1.0));
					half4 MasksData254_g240709 = appendResult253_g240709;
					float4 In_MasksData16_g240719 = MasksData254_g240709;
					float temp_output_17_0_g240721 = _ObjectPhaseMode;
					float Option70_g240721 = temp_output_17_0_g240721;
					float4 temp_output_3_0_g240721 = v.ase_color;
					float4 Channel70_g240721 = temp_output_3_0_g240721;
					float localSwitchChannel470_g240721 = SwitchChannel4( Option70_g240721 , Channel70_g240721 );
					half Phase_Value372_g240709 = localSwitchChannel470_g240721;
					float3 break319_g240709 = PivotWO133_g240709;
					half Pivot_Position322_g240709 = ( break319_g240709.x + break319_g240709.z );
					half Phase_Position357_g240709 = ( Phase_Value372_g240709 + Pivot_Position322_g240709 );
					float temp_output_248_0_g240709 = frac( Phase_Position357_g240709 );
					float4 appendResult177_g240709 = (float4(( (frac( ( Phase_Position357_g240709 + float3( 0.1235, 0.4973, 0.7149 ) ) )*2.0 + -1.0) * 5.0 ) , temp_output_248_0_g240709));
					half4 Phase_Data176_g240709 = appendResult177_g240709;
					float4 In_PhaseData16_g240719 = Phase_Data176_g240709;
					float4 In_TransformData16_g240719 = half4( 0, 0, 0, 1 );
					float4 In_RotationData16_g240719 = float4( 0,0,0,0 );
					float4 In_InterpolatorA16_g240719 = float4( 0,0,0,0 );
					BuildModelVertData( Data16_g240719 , In_Dummy16_g240719 , In_PositionOS16_g240719 , In_PositionWS16_g240719 , In_PositionWO16_g240719 , In_PositionRawOS16_g240719 , In_PivotOS16_g240719 , In_PivotWS16_g240719 , In_PivotWO16_g240719 , In_NormalOS16_g240719 , In_NormalWS16_g240719 , In_NormalRawOS16_g240719 , In_TangentOS16_g240719 , In_TangentWS16_g240719 , In_BitangentWS16_g240719 , In_ViewDirWS16_g240719 , In_CoordsData16_g240719 , In_VertexData16_g240719 , In_MasksData16_g240719 , In_PhaseData16_g240719 , In_TransformData16_g240719 , In_RotationData16_g240719 , In_InterpolatorA16_g240719 );
					TVEModelData Data15_g240730 =(TVEModelData)Data16_g240719;
					float Out_Dummy15_g240730 = 0.0;
					float3 Out_PositionOS15_g240730 = float3( 0,0,0 );
					float3 Out_PositionWS15_g240730 = float3( 0,0,0 );
					float3 Out_PositionWO15_g240730 = float3( 0,0,0 );
					float3 Out_PositionRawOS15_g240730 = float3( 0,0,0 );
					float3 Out_PivotOS15_g240730 = float3( 0,0,0 );
					float3 Out_PivotWS15_g240730 = float3( 0,0,0 );
					float3 Out_PivotWO15_g240730 = float3( 0,0,0 );
					float3 Out_NormalOS15_g240730 = float3( 0,0,0 );
					float3 Out_NormalWS15_g240730 = float3( 0,0,0 );
					float3 Out_NormalRawOS15_g240730 = float3( 0,0,0 );
					float4 Out_TangentOS15_g240730 = float4( 0,0,0,0 );
					float3 Out_TangentWS15_g240730 = float3( 0,0,0 );
					float3 Out_BitangentWS15_g240730 = float3( 0,0,0 );
					float3 Out_ViewDirWS15_g240730 = float3( 0,0,0 );
					float4 Out_CoordsData15_g240730 = float4( 0,0,0,0 );
					float4 Out_VertexData15_g240730 = float4( 0,0,0,0 );
					float4 Out_MasksData15_g240730 = float4( 0,0,0,0 );
					float4 Out_PhaseData15_g240730 = float4( 0,0,0,0 );
					float4 Out_TransformData15_g240730 = float4( 0,0,0,0 );
					float4 Out_RotationData15_g240730 = float4( 0,0,0,0 );
					float4 Out_InterpolatorA15_g240730 = float4( 0,0,0,0 );
					BreakModelVertData( Data15_g240730 , Out_Dummy15_g240730 , Out_PositionOS15_g240730 , Out_PositionWS15_g240730 , Out_PositionWO15_g240730 , Out_PositionRawOS15_g240730 , Out_PivotOS15_g240730 , Out_PivotWS15_g240730 , Out_PivotWO15_g240730 , Out_NormalOS15_g240730 , Out_NormalWS15_g240730 , Out_NormalRawOS15_g240730 , Out_TangentOS15_g240730 , Out_TangentWS15_g240730 , Out_BitangentWS15_g240730 , Out_ViewDirWS15_g240730 , Out_CoordsData15_g240730 , Out_VertexData15_g240730 , Out_MasksData15_g240730 , Out_PhaseData15_g240730 , Out_TransformData15_g240730 , Out_RotationData15_g240730 , Out_InterpolatorA15_g240730 );
					TVEModelData Data16_g240732 =(TVEModelData)Data15_g240730;
					float temp_output_14_0_g240732 = 0.0;
					float In_Dummy16_g240732 = temp_output_14_0_g240732;
					float3 temp_output_219_24_g240729 = Out_PivotOS15_g240730;
					float3 temp_output_215_0_g240729 = ( Out_PositionOS15_g240730 - temp_output_219_24_g240729 );
					float3 temp_output_4_0_g240732 = temp_output_215_0_g240729;
					float3 In_PositionOS16_g240732 = temp_output_4_0_g240732;
					float3 In_PositionWS16_g240732 = Out_PositionWS15_g240730;
					float3 In_PositionWO16_g240732 = Out_PositionWO15_g240730;
					float3 In_PositionRawOS16_g240732 = Out_PositionRawOS15_g240730;
					float3 In_PivotOS16_g240732 = temp_output_219_24_g240729;
					float3 In_PivotWS16_g240732 = Out_PivotWS15_g240730;
					float3 In_PivotWO16_g240732 = Out_PivotWO15_g240730;
					float3 temp_output_21_0_g240732 = Out_NormalOS15_g240730;
					float3 In_NormalOS16_g240732 = temp_output_21_0_g240732;
					float3 In_NormalWS16_g240732 = Out_NormalWS15_g240730;
					float3 In_NormalRawOS16_g240732 = Out_NormalRawOS15_g240730;
					float4 temp_output_6_0_g240732 = Out_TangentOS15_g240730;
					float4 In_TangentOS16_g240732 = temp_output_6_0_g240732;
					float3 In_TangentWS16_g240732 = Out_TangentWS15_g240730;
					float3 In_BitangentWS16_g240732 = Out_BitangentWS15_g240730;
					float3 In_ViewDirWS16_g240732 = Out_ViewDirWS15_g240730;
					float4 In_CoordsData16_g240732 = Out_CoordsData15_g240730;
					float4 In_VertexData16_g240732 = Out_VertexData15_g240730;
					float4 In_MasksData16_g240732 = Out_MasksData15_g240730;
					float4 In_PhaseData16_g240732 = Out_PhaseData15_g240730;
					float4 In_TransformData16_g240732 = Out_TransformData15_g240730;
					float4 In_RotationData16_g240732 = Out_RotationData15_g240730;
					float4 In_InterpolatorA16_g240732 = Out_InterpolatorA15_g240730;
					BuildModelVertData( Data16_g240732 , In_Dummy16_g240732 , In_PositionOS16_g240732 , In_PositionWS16_g240732 , In_PositionWO16_g240732 , In_PositionRawOS16_g240732 , In_PivotOS16_g240732 , In_PivotWS16_g240732 , In_PivotWO16_g240732 , In_NormalOS16_g240732 , In_NormalWS16_g240732 , In_NormalRawOS16_g240732 , In_TangentOS16_g240732 , In_TangentWS16_g240732 , In_BitangentWS16_g240732 , In_ViewDirWS16_g240732 , In_CoordsData16_g240732 , In_VertexData16_g240732 , In_MasksData16_g240732 , In_PhaseData16_g240732 , In_TransformData16_g240732 , In_RotationData16_g240732 , In_InterpolatorA16_g240732 );
					TVEModelData Data15_g240734 =(TVEModelData)Data16_g240732;
					float Out_Dummy15_g240734 = 0.0;
					float3 Out_PositionOS15_g240734 = float3( 0,0,0 );
					float3 Out_PositionWS15_g240734 = float3( 0,0,0 );
					float3 Out_PositionWO15_g240734 = float3( 0,0,0 );
					float3 Out_PositionRawOS15_g240734 = float3( 0,0,0 );
					float3 Out_PivotOS15_g240734 = float3( 0,0,0 );
					float3 Out_PivotWS15_g240734 = float3( 0,0,0 );
					float3 Out_PivotWO15_g240734 = float3( 0,0,0 );
					float3 Out_NormalOS15_g240734 = float3( 0,0,0 );
					float3 Out_NormalWS15_g240734 = float3( 0,0,0 );
					float3 Out_NormalRawOS15_g240734 = float3( 0,0,0 );
					float4 Out_TangentOS15_g240734 = float4( 0,0,0,0 );
					float3 Out_TangentWS15_g240734 = float3( 0,0,0 );
					float3 Out_BitangentWS15_g240734 = float3( 0,0,0 );
					float3 Out_ViewDirWS15_g240734 = float3( 0,0,0 );
					float4 Out_CoordsData15_g240734 = float4( 0,0,0,0 );
					float4 Out_VertexData15_g240734 = float4( 0,0,0,0 );
					float4 Out_MasksData15_g240734 = float4( 0,0,0,0 );
					float4 Out_PhaseData15_g240734 = float4( 0,0,0,0 );
					float4 Out_TransformData15_g240734 = float4( 0,0,0,0 );
					float4 Out_RotationData15_g240734 = float4( 0,0,0,0 );
					float4 Out_InterpolatorA15_g240734 = float4( 0,0,0,0 );
					BreakModelVertData( Data15_g240734 , Out_Dummy15_g240734 , Out_PositionOS15_g240734 , Out_PositionWS15_g240734 , Out_PositionWO15_g240734 , Out_PositionRawOS15_g240734 , Out_PivotOS15_g240734 , Out_PivotWS15_g240734 , Out_PivotWO15_g240734 , Out_NormalOS15_g240734 , Out_NormalWS15_g240734 , Out_NormalRawOS15_g240734 , Out_TangentOS15_g240734 , Out_TangentWS15_g240734 , Out_BitangentWS15_g240734 , Out_ViewDirWS15_g240734 , Out_CoordsData15_g240734 , Out_VertexData15_g240734 , Out_MasksData15_g240734 , Out_PhaseData15_g240734 , Out_TransformData15_g240734 , Out_RotationData15_g240734 , Out_InterpolatorA15_g240734 );
					TVEModelData Data16_g240735 =(TVEModelData)Data15_g240734;
					half Dummy317_g240733 = ( _ConformCategory + _ConformEnd + _ConformInfo );
					float temp_output_14_0_g240735 = Dummy317_g240733;
					float In_Dummy16_g240735 = temp_output_14_0_g240735;
					float3 temp_output_4_0_g240735 = Out_PositionOS15_g240734;
					float3 In_PositionOS16_g240735 = temp_output_4_0_g240735;
					float3 In_PositionWS16_g240735 = Out_PositionWS15_g240734;
					float3 temp_output_314_17_g240733 = Out_PositionWO15_g240734;
					float3 In_PositionWO16_g240735 = temp_output_314_17_g240733;
					float3 In_PositionRawOS16_g240735 = Out_PositionRawOS15_g240734;
					float3 In_PivotOS16_g240735 = Out_PivotOS15_g240734;
					float3 In_PivotWS16_g240735 = Out_PivotWS15_g240734;
					float3 temp_output_314_19_g240733 = Out_PivotWO15_g240734;
					float3 In_PivotWO16_g240735 = temp_output_314_19_g240733;
					float3 temp_output_21_0_g240735 = Out_NormalOS15_g240734;
					float3 In_NormalOS16_g240735 = temp_output_21_0_g240735;
					float3 In_NormalWS16_g240735 = Out_NormalWS15_g240734;
					float3 In_NormalRawOS16_g240735 = Out_NormalRawOS15_g240734;
					float4 temp_output_6_0_g240735 = Out_TangentOS15_g240734;
					float4 In_TangentOS16_g240735 = temp_output_6_0_g240735;
					float3 In_TangentWS16_g240735 = Out_TangentWS15_g240734;
					float3 In_BitangentWS16_g240735 = Out_BitangentWS15_g240734;
					float3 In_ViewDirWS16_g240735 = Out_ViewDirWS15_g240734;
					float4 In_CoordsData16_g240735 = Out_CoordsData15_g240734;
					float4 temp_output_314_29_g240733 = Out_VertexData15_g240734;
					float4 In_VertexData16_g240735 = temp_output_314_29_g240733;
					float4 In_MasksData16_g240735 = Out_MasksData15_g240734;
					float4 In_PhaseData16_g240735 = Out_PhaseData15_g240734;
					half4 Model_TransformData356_g240733 = Out_TransformData15_g240734;
					...
					float4 temp_output_589_164_g240632 = TVE_CoatParams;
					half4 Coat_Params596_g240632 = temp_output_589_164_g240632;
					float4 In_CoatParams204_g240632 = Coat_Params596_g240632;
					float4 temp_output_203_0_g240652 = TVE_CoatBaseCoord;
					TVEModelData Data16_g240717 =(TVEModelData)(TVEModelData)0;
					float In_Dummy16_g240717 = 0.0;
					float3 In_PositionWS16_g240717 = PositionWS122_g240709;
					float3 In_PositionWO16_g240717 = PositionWO132_g240709;
					float3 In_PivotWS16_g240717 = PivotWS121_g240709;
					float3 In_PivotWO16_g240717 = PivotWO133_g240709;
					float3 In_NormalWS16_g240717 = NormalWS95_g240709;
					float3 In_TangentWS16_g240717 = TangentWS136_g240709;
					float3 In_BitangentWS16_g240717 = BiangentWS421_g240709;
					half3 NormalWS427_g240709 = NormalWS95_g240709;
					half3 localComputeTriplanarWeights427_g240709 = ComputeTriplanarWeights( NormalWS427_g240709 );
					half3 TriplanarWeights429_g240709 = localComputeTriplanarWeights427_g240709;
					float3 In_TriplanarWeights16_g240717 = TriplanarWeights429_g240709;
					float3 In_ViewDirWS16_g240717 = ViewDirWS169_g240709;
					float4 In_CoordsData16_g240717 = CoordsData398_g240709;
					float4 In_VertexData16_g240717 = VertexMasks171_g240709;
					float4 In_PhaseData16_g240717 = Phase_Data176_g240709;
					BuildModelFragData( Data16_g240717 , In_Dummy16_g240717 , In_PositionWS16_g240717 , In_PositionWO16_g240717 , In_PivotWS16_g240717 , In_PivotWO16_g240717 , In_NormalWS16_g240717 , In_TangentWS16_g240717 , In_BitangentWS16_g240717 , In_TriplanarWeights16_g240717 , In_ViewDirWS16_g240717 , In_CoordsData16_g240717 , In_VertexData16_g240717 , In_PhaseData16_g240717 );
					TVEModelData Data15_g240708 =(TVEModelData)Data16_g240717;
					float Out_Dummy15_g240708 = 0.0;
					float3 Out_PositionWS15_g240708 = float3( 0,0,0 );
					float3 Out_PositionWO15_g240708 = float3( 0,0,0 );
					float3 Out_PivotWS15_g240708 = float3( 0,0,0 );
					float3 Out_PivotWO15_g240708 = float3( 0,0,0 );
					float3 Out_NormalWS15_g240708 = float3( 0,0,0 );
					float3 Out_TangentWS15_g240708 = float3( 0,0,0 );
					float3 Out_BitangentWS15_g240708 = float3( 0,0,0 );
					float3 Out_TriplanarWeights15_g240708 = float3( 0,0,0 );
					float3 Out_ViewDirWS15_g240708 = float3( 0,0,0 );
					float4 Out_CoordsData15_g240708 = float4( 0,0,0,0 );
					float4 Out_VertexData15_g240708 = float4( 0,0,0,0 );
					float4 Out_PhaseData15_g240708 = float4( 0,0,0,0 );
					BreakModelFragData( Data15_g240708 , Out_Dummy15_g240708 , Out_PositionWS15_g240708 , Out_PositionWO15_g240708 , Out_PivotWS15_g240708 , Out_PivotWO15_g240708 , Out_NormalWS15_g240708 , Out_TangentWS15_g240708 , Out_BitangentWS15_g240708 , Out_TriplanarWeights15_g240708 , Out_ViewDirWS15_g240708 , Out_CoordsData15_g240708 , Out_VertexData15_g240708 , Out_PhaseData15_g240708 );
					float3 Model_PositionWS497_g240632 = Out_PositionWS15_g240708;
					float2 Model_PositionWS_XZ143_g240632 = (Model_PositionWS497_g240632).xz;
					float3 Model_PivotWS498_g240632 = Out_PivotWS15_g240708;
					...
					float2 temp_output_81_0_g240652 = lerpResult300_g240632;
					float temp_output_82_0_g240650 = _GlobalCoatLayerValue;
					float temp_output_82_0_g240652 = temp_output_82_0_g240650;
					float4 tex2DArrayNode83_g240652 = SAMPLE_TEXTURE2D_ARRAY_LOD( TVE_CoatBaseTex, sampler_Linear_Clamp, float3(( (temp_output_203_0_g240652).zw + ( (temp_output_203_0_g240652).xy * temp_output_81_0_g240652 ) ),temp_output_82_0_g240652), 0.0 );
					float4 appendResult210_g240652 = (float4(tex2DArrayNode83_g240652.rgb , saturate( tex2DArrayNode83_g240652.a )));
					float4 temp_output_204_0_g240652 = TVE_CoatNearCoord;
					float4 tex2DArrayNode122_g240652 = SAMPLE_TEXTURE2D_ARRAY_LOD( TVE_CoatNearTex, sampler_Linear_Repeat, float3(( (temp_output_204_0_g240652).zw + ( (temp_output_204_0_g240652).xy * temp_output_81_0_g240652 ) ),temp_output_82_0_g240652), 0.0 );
					float4 appendResult212_g240652 = (float4(tex2DArrayNode122_g240652.rgb , saturate( tex2DArrayNode122_g240652.a )));
					...
					float temp_output_7_0_g240633 = 1.0;
					float temp_output_9_0_g240633 = ( temp_output_507_0_g240632 - temp_output_7_0_g240633 );
					half TVE_RenderNearFadeValue635_g240632 = TVE_RenderNearFadeValue;
					half Global_TexBlend509_g240632 = saturate( ( temp_output_9_0_g240633 / ( ( TVE_RenderNearFadeValue635_g240632 - temp_output_7_0_g240633 ) + 0.0001 ) ) );
					float4 lerpResult131_g240652 = lerp( appendResult210_g240652 , appendResult212_g240652 , Global_TexBlend509_g240632);
					float4 temp_output_159_109_g240650 = lerpResult131_g240652;
					float4 lerpResult168_g240650 = lerp( TVE_CoatParams , temp_output_159_109_g240650 , TVE_CoatLayers[(int)temp_output_82_0_g240650]);
					float4 temp_output_589_109_g240632 = lerpResult168_g240650;
					half4 Coat_Texture302_g240632 = temp_output_589_109_g240632;
					float4 In_CoatTexture204_g240632 = Coat_Texture302_g240632;
					float4 temp_output_595_164_g240632 = TVE_PaintParams;
					half4 Paint_Params575_g240632 = temp_output_595_164_g240632;
					float4 In_PaintParams204_g240632 = Paint_Params575_g240632;
					float4 temp_output_203_0_g240701 = TVE_PaintBaseCoord;
					float2 lerpResult85_g240632 = lerp( Model_PositionWS_XZ143_g240632 , Model_PivotWS_XZ145_g240632 , _GlobalPaintPivotValue);
					float2 temp_output_81_0_g240701 = lerpResult85_g240632;
					float temp_output_82_0_g240698 = _GlobalPaintLayerValue;
					float temp_output_82_0_g240701 = temp_output_82_0_g240698;
					float4 tex2DArrayNode83_g240701 = SAMPLE_TEXTURE2D_ARRAY_LOD( TVE_PaintBaseTex, sampler_Linear_Clamp, float3(( (temp_output_203_0_g240701).zw + ( (temp_output_203_0_g240701).xy * temp_output_81_0_g240701 ) ),temp_output_82_0_g240701), 0.0 );
					float4 appendResult210_g240701 = (float4(tex2DArrayNode83_g240701.rgb , saturate( tex2DArrayNode83_g240701.a )));
					float4 temp_output_204_0_g240701 = TVE_PaintNearCoord;
					float4 tex2DArrayNode122_g240701 = SAMPLE_TEXTURE2D_ARRAY_LOD( TVE_PaintNearTex, sampler_Linear_Repeat, float3(( (temp_output_204_0_g240701).zw + ( (temp_output_204_0_g240701).xy * temp_output_81_0_g240701 ) ),temp_output_82_0_g240701), 0.0 );
					float4 appendResult212_g240701 = (float4(tex2DArrayNode122_g240701.rgb , saturate( tex2DArrayNode122_g240701.a )));
					float4 lerpResult131_g240701 = lerp( appendResult210_g240701 , appendResult212_g240701 , Global_TexBlend509_g240632);
					float4 temp_output_171_109_g240698 = lerpResult131_g240701;
					float4 lerpResult174_g240698 = lerp( TVE_PaintParams , temp_output_171_109_g240698 , TVE_PaintLayers[(int)temp_output_82_0_g240698]);
					float4 temp_output_595_109_g240632 = lerpResult174_g240698;
					half4 Paint_Texture71_g240632 = temp_output_595_109_g240632;
					float4 In_PaintTexture204_g240632 = Paint_Texture71_g240632;
					float4 temp_output_590_141_g240632 = TVE_AtmoParams;
					half4 Atmo_Params601_g240632 = temp_output_590_141_g240632;
					float4 In_AtmoParams204_g240632 = Atmo_Params601_g240632;
					float4 temp_output_203_0_g240660 = TVE_AtmoBaseCoord;
					float2 lerpResult104_g240632 = lerp( Model_PositionWS_XZ143_g240632 , Model_PivotWS_XZ145_g240632 , _GlobalAtmoPivotValue);
					float2 temp_output_81_0_g240660 = lerpResult104_g240632;
					float temp_output_132_0_g240658 = _GlobalAtmoLayerValue;
					float temp_output_82_0_g240660 = temp_output_132_0_g240658;
					float4 tex2DArrayNode83_g240660 = SAMPLE_TEXTURE2D_ARRAY_LOD( TVE_AtmoBaseTex, sampler_Linear_Clamp, float3(( (temp_output_203_0_g240660).zw + ( (temp_output_203_0_g240660).xy * temp_output_81_0_g240660 ) ),temp_output_82_0_g240660), 0.0 );
					float4 appendResult210_g240660 = (float4(tex2DArrayNode83_g240660.rgb , saturate( tex2DArrayNode83_g240660.a )));
					float4 temp_output_204_0_g240660 = TVE_AtmoNearCoord;
					float4 tex2DArrayNode122_g240660 = SAMPLE_TEXTURE2D_ARRAY_LOD( TVE_AtmoNearTex, sampler_Linear_Repeat, float3(( (temp_output_204_0_g240660).zw + ( (temp_output_204_0_g240660).xy * temp_output_81_0_g240660 ) ),temp_output_82_0_g240660), 0.0 );
					float4 appendResult212_g240660 = (float4(tex2DArrayNode122_g240660.rgb , saturate( tex2DArrayNode122_g240660.a )));
					float4 lerpResult131_g240660 = lerp( appendResult210_g240660 , appendResult212_g240660 , Global_TexBlend509_g240632);
					float4 temp_output_137_109_g240658 = lerpResult131_g240660;
					float4 lerpResult145_g240658 = lerp( TVE_AtmoParams , temp_output_137_109_g240658 , TVE_AtmoLayers[(int)temp_output_132_0_g240658]);
					float4 temp_output_590_110_g240632 = lerpResult145_g240658;
					half4 Atmo_Texture80_g240632 = temp_output_590_110_g240632;
					float4 In_AtmoTexture204_g240632 = Atmo_Texture80_g240632;
					float4 temp_output_593_163_g240632 = TVE_GlowParams;
					half4 Glow_Params609_g240632 = temp_output_593_163_g240632;
					float4 In_GlowParams204_g240632 = Glow_Params609_g240632;
					float4 temp_output_203_0_g240676 = TVE_GlowBaseCoord;
					float2 lerpResult247_g240632 = lerp( Model_PositionWS_XZ143_g240632 , Model_PivotWS_XZ145_g240632 , _GlobalGlowPivotValue);
					float2 temp_output_81_0_g240676 = lerpResult247_g240632;
					float temp_output_82_0_g240674 = _GlobalGlowLayerValue;
					float temp_output_82_0_g240676 = temp_output_82_0_g240674;
					float4 tex2DArrayNode83_g240676 = SAMPLE_TEXTURE2D_ARRAY_LOD( TVE_GlowBaseTex, sampler_Linear_Clamp, float3(( (temp_output_203_0_g240676).zw + ( (temp_output_203_0_g240676).xy * temp_output_81_0_g240676 ) ),temp_output_82_0_g240676), 0.0 );
					float4 appendResult210_g240676 = (float4(tex2DArrayNode83_g240676.rgb , saturate( tex2DArrayNode83_g240676.a )));
					float4 temp_output_204_0_g240676 = TVE_GlowNearCoord;
					float4 tex2DArrayNode122_g240676 = SAMPLE_TEXTURE2D_ARRAY_LOD( TVE_GlowNearTex, sampler_Linear_Repeat, float3(( (temp_output_204_0_g240676).zw + ( (temp_output_204_0_g240676).xy * temp_output_81_0_g240676 ) ),temp_output_82_0_g240676), 0.0 );
					float4 appendResult212_g240676 = (float4(tex2DArrayNode122_g240676.rgb , saturate( tex2DArrayNode122_g240676.a )));
					float4 lerpResult131_g240676 = lerp( appendResult210_g240676 , appendResult212_g240676 , Global_TexBlend509_g240632);
					float4 temp_output_159_109_g240674 = lerpResult131_g240676;
					float4 lerpResult167_g240674 = lerp( TVE_GlowParams , temp_output_159_109_g240674 , TVE_GlowLayers[(int)temp_output_82_0_g240674]);
					float4 temp_output_593_109_g240632 = lerpResult167_g240674;
					half4 Glow_Texture248_g240632 = temp_output_593_109_g240632;
					float4 In_GlowTexture204_g240632 = Glow_Texture248_g240632;
					float4 temp_output_592_139_g240632 = TVE_FormParams;
					float4 Form_Params606_g240632 = temp_output_592_139_g240632;
					float4 In_FormParams204_g240632 = Form_Params606_g240632;
					float4 temp_output_203_0_g240692 = TVE_FormBaseCoord;
					float2 lerpResult168_g240632 = lerp( Model_PositionWS_XZ143_g240632 , Model_PivotWS_XZ145_g240632 , _GlobalFormPivotValue);
					float2 temp_output_81_0_g240692 = lerpResult168_g240632;
					float temp_output_130_0_g240690 = _GlobalFormLayerValue;
					float temp_output_82_0_g240692 = temp_output_130_0_g240690;
					float4 tex2DArrayNode83_g240692 = SAMPLE_TEXTURE2D_ARRAY_LOD( TVE_FormBaseTex, sampler_Linear_Clamp, float3(( (temp_output_203_0_g240692).zw + ( (temp_output_203_0_g240692).xy * temp_output_81_0_g240692 ) ),temp_output_82_0_g240692), 0.0 );
					float4 appendResult210_g240692 = (float4(tex2DArrayNode83_g240692.rgb , saturate( tex2DArrayNode83_g240692.a )));
					float4 temp_output_204_0_g240692 = TVE_FormNearCoord;
					float4 tex2DArrayNode122_g240692 = SAMPLE_TEXTURE2D_ARRAY_LOD( TVE_FormNearTex, sampler_Linear_Repeat, float3(( (temp_output_204_0_g240692).zw + ( (temp_output_204_0_g240692).xy * temp_output_81_0_g240692 ) ),temp_output_82_0_g240692), 0.0 );
					float4 appendResult212_g240692 = (float4(tex2DArrayNode122_g240692.rgb , saturate( tex2DArrayNode122_g240692.a )));
					float4 lerpResult131_g240692 = lerp( appendResult210_g240692 , appendResult212_g240692 , Global_TexBlend509_g240632);
					float4 temp_output_135_109_g240690 = lerpResult131_g240692;
					float4 lerpResult143_g240690 = lerp( TVE_FormParams , temp_output_135_109_g240690 , TVE_FormLayers[(int)temp_output_130_0_g240690]);
					float4 temp_output_592_0_g240632 = lerpResult143_g240690;
					float4 Form_Texture112_g240632 = temp_output_592_0_g240632;
					float4 In_FormTexture204_g240632 = Form_Texture112_g240632;
					float4 temp_output_594_145_g240632 = TVE_FlowParams;
					half4 Flow_Params612_g240632 = temp_output_594_145_g240632;
					float4 In_FlowParams204_g240632 = Flow_Params612_g240632;
					float4 temp_output_203_0_g240684 = TVE_FlowBaseCoord;
					float2 lerpResult400_g240632 = lerp( Model_PositionWS_XZ143_g240632 , Model_PivotWS_XZ145_g240632 , _GlobalFlowPivotValue);
					float2 temp_output_81_0_g240684 = lerpResult400_g240632;
					float temp_output_136_0_g240682 = _GlobalFlowLayerValue;
					float temp_output_82_0_g240684 = temp_output_136_0_g240682;
					float4 tex2DArrayNode83_g240684 = SAMPLE_TEXTURE2D_ARRAY_LOD( TVE_FlowBaseTex, sampler_Linear_Clamp, float3(( (temp_output_203_0_g240684).zw + ( (temp_output_203_0_g240684).xy * temp_output_81_0_g240684 ) ),temp_output_82_0_g240684), 0.0 );
					float4 appendResult210_g240684 = (float4(tex2DArrayNode83_g240684.rgb , saturate( tex2DArrayNode83_g240684.a )));
					float4 temp_output_204_0_g240684 = TVE_FlowNearCoord;
					float4 tex2DArrayNode122_g240684 = SAMPLE_TEXTURE2D_ARRAY_LOD( TVE_FlowNearTex, sampler_Linear_Repeat, float3(( (temp_output_204_0_g240684).zw + ( (temp_output_204_0_g240684).xy * temp_output_81_0_g240684 ) ),temp_output_82_0_g240684), 0.0 );
					float4 appendResult212_g240684 = (float4(tex2DArrayNode122_g240684.rgb , saturate( tex2DArrayNode122_g240684.a )));
					float4 lerpResult131_g240684 = lerp( appendResult210_g240684 , appendResult212_g240684 , Global_TexBlend509_g240632);
					float4 temp_output_141_109_g240682 = lerpResult131_g240684;
					float4 lerpResult149_g240682 = lerp( TVE_FlowParams , temp_output_141_109_g240682 , TVE_FlowLayers[(int)temp_output_136_0_g240682]);
					half4 Flow_Texture405_g240632 = lerpResult149_g240682;
					float4 In_FlowTexture204_g240632 = Flow_Texture405_g240632;
					BuildGlobalData( Data204_g240632 , In_Dummy204_g240632 , In_CoatParams204_g240632 , In_CoatTexture204_g240632 , In_PaintParams204_g240632 , In_PaintTexture204_g240632 , In_AtmoParams204_g240632 , In_AtmoTexture204_g240632 , In_GlowParams204_g240632 , In_GlowTexture204_g240632 , In_FormParams204_g240632 , In_FormTexture204_g240632 , In_FlowParams204_g240632 , In_FlowTexture204_g240632 );
					TVEGlobalData Data15_g240736 =(TVEGlobalData)Data204_g240632;
					float Out_Dummy15_g240736 = 0.0;
					float4 Out_CoatParams15_g240736 = float4( 0,0,0,0 );
					float4 Out_CoatTexture15_g240736 = float4( 0,0,0,0 );
					float4 Out_PaintParams15_g240736 = float4( 0,0,0,0 );
					float4 Out_PaintTexture15_g240736 = float4( 0,0,0,0 );
					float4 Out_AtmoParams15_g240736 = float4( 0,0,0,0 );
					float4 Out_AtmoTexture15_g240736 = float4( 0,0,0,0 );
					float4 Out_GlowParams15_g240736 = float4( 0,0,0,0 );
					float4 Out_GlowTexture15_g240736 = float4( 0,0,0,0 );
					float4 Out_FormParams15_g240736 = float4( 0,0,0,0 );
					float4 Out_FormTexture15_g240736 = float4( 0,0,0,0 );
					float4 Out_FlowParams15_g240736 = float4( 0,0,0,0 );
					float4 Out_FlowTexture15_g240736 = float4( 0,0,0,0 );
					BreakData( Data15_g240736 , Out_Dummy15_g240736 , Out_CoatParams15_g240736 , Out_CoatTexture15_g240736 , Out_PaintParams15_g240736 , Out_PaintTexture15_g240736 , Out_AtmoParams15_g240736 , Out_AtmoTexture15_g240736 , Out_GlowParams15_g240736 , Out_GlowTexture15_g240736 , Out_FormParams15_g240736 , Out_FormTexture15_g240736 , Out_FlowParams15_g240736 , Out_FlowTexture15_g240736 );
					float4 Global_FormTexture351_g240733 = Out_FormTexture15_g240736;
					float3 Model_PivotWO353_g240733 = temp_output_314_19_g240733;
					float3 ase_objectScale = float3( length( unity_ObjectToWorld[ 0 ].xyz ), length( unity_ObjectToWorld[ 1 ].xyz ), length( unity_ObjectToWorld[ 2 ].xyz ) );
					float temp_output_17_0_g240742 = _ConformMeshMode;
					float Option70_g240742 = temp_output_17_0_g240742;
					half4 Model_VertexData357_g240733 = temp_output_314_29_g240733;
					float4 temp_output_3_0_g240742 = Model_VertexData357_g240733;
					float4 Channel70_g240742 = temp_output_3_0_g240742;
					float localSwitchChannel470_g240742 = SwitchChannel4( Option70_g240742 , Channel70_g240742 );
					float temp_output_390_0_g240733 = localSwitchChannel470_g240742;
					float temp_output_7_0_g240739 = _ConformMeshRemap.x;
					float temp_output_9_0_g240739 = ( temp_output_390_0_g240733 - temp_output_7_0_g240739 );
					float lerpResult374_g240733 = lerp( 1.0 , saturate( ( temp_output_9_0_g240739 * _ConformMeshRemap.z ) ) , _ConformMeshValue);
					half Blend_VertMask379_g240733 = lerpResult374_g240733;
					float temp_output_328_0_g240733 = ( Blend_VertMask379_g240733 * TVE_IsEnabled );
					half Conform_Mask366_g240733 = temp_output_328_0_g240733;
					float temp_output_322_0_g240733 = ( ( ( ( (Global_FormTexture351_g240733).z - ( (Model_PivotWO353_g240733).y * _ConformMode ) ) + _ConformOffsetValue ) / ase_objectScale.y ) * ( _ConformIntensityValue * Conform_Mask366_g240733 ) );
					float3 appendResult329_g240733 = (float3(0.0 , temp_output_322_0_g240733 , 0.0));
					float3 appendResult387_g240733 = (float3(0.0 , 0.0 , temp_output_322_0_g240733));
					#ifdef TVE_COORD_ZUP
					float3 staticSwitch65_g240740 = appendResult387_g240733;
					#else
					float3 staticSwitch65_g240740 = appendResult329_g240733;
					#endif
					float3 Blanket_Conform368_g240733 = staticSwitch65_g240740;
					float4 appendResult312_g240733 = (float4(Blanket_Conform368_g240733 , 0.0));
					float4 temp_output_310_0_g240733 = ( Model_TransformData356_g240733 + appendResult312_g240733 );
					#ifdef TVE_CONFORM
					float4 staticSwitch364_g240733 = temp_output_310_0_g240733;
					#else
					float4 staticSwitch364_g240733 = Model_TransformData356_g240733;
					#endif
					half4 Final_TransformData365_g240733 = staticSwitch364_g240733;
					float4 In_TransformData16_g240735 = Final_TransformData365_g240733;
					float4 In_RotationData16_g240735 = Out_RotationData15_g240734;
					float4 In_InterpolatorA16_g240735 = Out_InterpolatorA15_g240734;
					BuildModelVertData( Data16_g240735 , In_Dummy16_g240735 , In_PositionOS16_g240735 , In_PositionWS16_g240735 , In_PositionWO16_g240735 , In_PositionRawOS16_g240735 , In_PivotOS16_g240735 , In_PivotWS16_g240735 , In_PivotWO16_g240735 , In_NormalOS16_g240735 , In_NormalWS16_g240735 , In_NormalRawOS16_g240735 , In_TangentOS16_g240735 , In_TangentWS16_g240735 , In_BitangentWS16_g240735 , In_ViewDirWS16_g240735 , In_CoordsData16_g240735 , In_VertexData16_g240735 , In_MasksData16_g240735 , In_PhaseData16_g240735 , In_TransformData16_g240735 , In_RotationData16_g240735 , In_InterpolatorA16_g240735 );
					TVEModelData Data15_g240748 =(TVEModelData)Data16_g240735;
					float Out_Dummy15_g240748 = 0.0;
					float3 Out_PositionOS15_g240748 = float3( 0,0,0 );
					float3 Out_PositionWS15_g240748 = float3( 0,0,0 );
					float3 Out_PositionWO15_g240748 = float3( 0,0,0 );
					float3 Out_PositionRawOS15_g240748 = float3( 0,0,0 );
					float3 Out_PivotOS15_g240748 = float3( 0,0,0 );
					float3 Out_PivotWS15_g240748 = float3( 0,0,0 );
					float3 Out_PivotWO15_g240748 = float3( 0,0,0 );
					float3 Out_NormalOS15_g240748 = float3( 0,0,0 );
					float3 Out_NormalWS15_g240748 = float3( 0,0,0 );
					float3 Out_NormalRawOS15_g240748 = float3( 0,0,0 );
					float4 Out_TangentOS15_g240748 = float4( 0,0,0,0 );
					float3 Out_TangentWS15_g240748 = float3( 0,0,0 );
					float3 Out_BitangentWS15_g240748 = float3( 0,0,0 );
					float3 Out_ViewDirWS15_g240748 = float3( 0,0,0 );
					float4 Out_CoordsData15_g240748 = float4( 0,0,0,0 );
					float4 Out_VertexData15_g240748 = float4( 0,0,0,0 );
					float4 Out_MasksData15_g240748 = float4( 0,0,0,0 );
					float4 Out_PhaseData15_g240748 = float4( 0,0,0,0 );
					float4 Out_TransformData15_g240748 = float4( 0,0,0,0 );
					float4 Out_RotationData15_g240748 = float4( 0,0,0,0 );
					float4 Out_InterpolatorA15_g240748 = float4( 0,0,0,0 );
					BreakModelVertData( Data15_g240748 , Out_Dummy15_g240748 , Out_PositionOS15_g240748 , Out_PositionWS15_g240748 , Out_PositionWO15_g240748 , Out_PositionRawOS15_g240748 , Out_PivotOS15_g240748 , Out_PivotWS15_g240748 , Out_PivotWO15_g240748 , Out_NormalOS15_g240748 , Out_NormalWS15_g240748 , Out_NormalRawOS15_g240748 , Out_TangentOS15_g240748 , Out_TangentWS15_g240748 , Out_BitangentWS15_g240748 , Out_ViewDirWS15_g240748 , Out_CoordsData15_g240748 , Out_VertexData15_g240748 , Out_MasksData15_g240748 , Out_PhaseData15_g240748 , Out_TransformData15_g240748 , Out_RotationData15_g240748 , Out_InterpolatorA15_g240748 );
					TVEModelData Data16_g240749 =(TVEModelData)Data15_g240748;
					float temp_output_14_0_g240749 = 0.0;
					float In_Dummy16_g240749 = temp_output_14_0_g240749;
					float3 Model_PositionOS147_g240747 = Out_PositionOS15_g240748;
					half3 VertexPos40_g240753 = Model_PositionOS147_g240747;
					float4 temp_output_1567_33_g240747 = Out_RotationData15_g240748;
					half4 Model_RotationData1569_g240747 = temp_output_1567_33_g240747;
					float2 break1582_g240747 = (Model_RotationData1569_g240747).xy;
					half Angle44_g240753 = break1582_g240747.y;
					half CosAngle89_g240753 = cos( Angle44_g240753 );
					half SinAngle93_g240753 = sin( Angle44_g240753 );
					float3 appendResult95_g240753 = (float3((VertexPos40_g240753).x , ( ( (VertexPos40_g240753).y * CosAngle89_g240753 ) - ( (VertexPos40_g240753).z * SinAngle93_g240753 ) ) , ( ( (VertexPos40_g240753).y * SinAngle93_g240753 ) + ( (VertexPos40_g240753).z * CosAngle89_g240753 ) )));
					half3 VertexPos40_g240754 = appendResult95_g240753;
					half Angle44_g240754 = -break1582_g240747.x;
					half CosAngle94_g240754 = cos( Angle44_g240754 );
					half SinAngle95_g240754 = sin( Angle44_g240754 );
					float3 appendResult98_g240754 = (float3(( ( (VertexPos40_g240754).x * CosAngle94_g240754 ) - ( (VertexPos40_g240754).y * SinAngle95_g240754 ) ) , ( ( (VertexPos40_g240754).x * SinAngle95_g240754 ) + ( (VertexPos40_g240754).y * CosAngle94_g240754 ) ) , (VertexPos40_g240754).z));
					half3 VertexPos40_g240752 = Model_PositionOS147_g240747;
					half Angle44_g240752 = break1582_g240747.y;
					half CosAngle89_g240752 = cos( Angle44_g240752 );
					half SinAngle93_g240752 = sin( Angle44_g240752 );
					float3 appendResult95_g240752 = (float3((VertexPos40_g240752).x , ( ( (VertexPos40_g240752).y * CosAngle89_g240752 ) - ( (VertexPos40_g240752).z * SinAngle93_g240752 ) ) , ( ( (VertexPos40_g240752).y * SinAngle93_g240752 ) + ( (VertexPos40_g240752).z * CosAngle89_g240752 ) )));
					half3 VertexPos40_g240757 = appendResult95_g240752;
					half Angle44_g240757 = break1582_g240747.x;
					half CosAngle91_g240757 = cos( Angle44_g240757 );
					half SinAngle92_g240757 = sin( Angle44_g240757 );
					float3 appendResult93_g240757 = (float3(( ( (VertexPos40_g240757).x * CosAngle91_g240757 ) + ( (VertexPos40_g240757).z * SinAngle92_g240757 ) ) , (VertexPos40_g240757).y , ( ( -(VertexPos40_g240757).x * SinAngle92_g240757 ) + ( (VertexPos40_g240757).z * CosAngle91_g240757 ) )));
					#ifdef TVE_COORD_ZUP
					float3 staticSwitch65_g240755 = appendResult93_g240757;
					#else
					float3 staticSwitch65_g240755 = appendResult98_g240754;
					#endif
					#ifdef TVE_ROTATION_BEND
					float3 staticSwitch65_g240750 = staticSwitch65_g240755;
					#else
					float3 staticSwitch65_g240750 = Model_PositionOS147_g240747;
					#endif
					float3 temp_output_1608_0_g240747 = staticSwitch65_g240750;
					half3 VertexPos40_g240756 = temp_output_1608_0_g240747;
					half Angle44_g240756 = (Model_RotationData1569_g240747).z;
					half CosAngle91_g240756 = cos( Angle44_g240756 );
					half SinAngle92_g240756 = sin( Angle44_g240756 );
					float3 appendResult93_g240756 = (float3(( ( (VertexPos40_g240756).x * CosAngle91_g240756 ) + ( (VertexPos40_g240756).z * SinAngle92_g240756 ) ) , (VertexPos40_g240756).y , ( ( -(VertexPos40_g240756).x * SinAngle92_g240756 ) + ( (VertexPos40_g240756).z * CosAngle91_g240756 ) )));
					#ifdef TVE_ROTATION_ROLL
					float3 staticSwitch65_g240751 = appendResult93_g240756;
					#else
					float3 staticSwitch65_g240751 = temp_output_1608_0_g240747;
					#endif
					float4 temp_output_1567_31_g240747 = Out_TransformData15_g240748;
					half4 Model_TransformData1568_g240747 = temp_output_1567_31_g240747;
					half3 Final_PositionOS178_g240747 = ( ( staticSwitch65_g240751 * (Model_TransformData1568_g240747).w ) + (Model_TransformData1568_g240747).xyz );
					float3 temp_output_4_0_g240749 = Final_PositionOS178_g240747;
					float3 In_PositionOS16_g240749 = temp_output_4_0_g240749;
					float3 In_PositionWS16_g240749 = Out_PositionWS15_g240748;
					float3 In_PositionWO16_g240749 = Out_PositionWO15_g240748;
					float3 In_PositionRawOS16_g240749 = Out_PositionRawOS15_g240748;
					float3 In_PivotOS16_g240749 = Out_PivotOS15_g240748;
					float3 In_PivotWS16_g240749 = Out_PivotWS15_g240748;
					float3 In_PivotWO16_g240749 = Out_PivotWO15_g240748;
					float3 temp_output_21_0_g240749 = Out_NormalOS15_g240748;
					float3 In_NormalOS16_g240749 = temp_output_21_0_g240749;
					float3 In_NormalWS16_g240749 = Out_NormalWS15_g240748;
					float3 In_NormalRawOS16_g240749 = Out_NormalRawOS15_g240748;
					float4 temp_output_6_0_g240749 = Out_TangentOS15_g240748;
					float4 In_TangentOS16_g240749 = temp_output_6_0_g240749;
					float3 In_TangentWS16_g240749 = Out_TangentWS15_g240748;
					float3 In_BitangentWS16_g240749 = Out_BitangentWS15_g240748;
					float3 In_ViewDirWS16_g240749 = Out_ViewDirWS15_g240748;
					float4 In_CoordsData16_g240749 = Out_CoordsData15_g240748;
					float4 In_VertexData16_g240749 = Out_VertexData15_g240748;
					float4 In_MasksData16_g240749 = Out_MasksData15_g240748;
					float4 In_PhaseData16_g240749 = Out_PhaseData15_g240748;
					float4 In_TransformData16_g240749 = temp_output_1567_31_g240747;
					float4 In_RotationData16_g240749 = temp_output_1567_33_g240747;
					float4 In_InterpolatorA16_g240749 = Out_InterpolatorA15_g240748;
					BuildModelVertData( Data16_g240749 , In_Dummy16_g240749 , In_PositionOS16_g240749 , In_PositionWS16_g240749 , In_PositionWO16_g240749 , In_PositionRawOS16_g240749 , In_PivotOS16_g240749 , In_PivotWS16_g240749 , In_PivotWO16_g240749 , In_NormalOS16_g240749 , In_NormalWS16_g240749 , In_NormalRawOS16_g240749 , In_TangentOS16_g240749 , In_TangentWS16_g240749 , In_BitangentWS16_g240749 , In_ViewDirWS16_g240749 , In_CoordsData16_g240749 , In_VertexData16_g240749 , In_MasksData16_g240749 , In_PhaseData16_g240749 , In_TransformData16_g240749 , In_RotationData16_g240749 , In_InterpolatorA16_g240749 );
					TVEModelData Data15_g251358 =(TVEModelData)Data16_g240749;
					...
					o.ase_texcoord6 = ase_positionCS57_g251362;
					o.ase_texcoord7.xyz = vertexToFrag73_g240709;
					o.ase_texcoord8.xyz = vertexToFrag76_g240709;
							...
							) : SV_Target
				{
					...
					float2 FinalUV13_g251363 = ( temp_cast_3 * ( 0.5 + appendResult128_g251364 ) );
					...
					float2 clampResult57_g251363 = clamp( ( ( ( abs( ( frac( ( FinalUV13_g251363 + 0.25 ) ) - temp_cast_4 ) ) * 4.0 ) - temp_cast_5 ) * ( 0.35 / derivativesLength29_g251363 ) ) , temp_cast_6 , temp_cast_7 );
					...
					float3 ifLocalVar40_g240743 = 0;
					if( IsShaderType2402 == 1.0 )
					ifLocalVar40_g240743 = color2395.rgb;
					float4 color2398 = IsGammaSpace() ? float4( 0.6196079, 0.7686275, 0.1490196, 0 ) : float4( 0.3419145, 0.5520116, 0.01938236, 0 );
					float3 ifLocalVar40_g240744 = 0;
					if( IsShaderType2402 == 2.0 )
					ifLocalVar40_g240744 = color2398.rgb;
					float4 color2391 = IsGammaSpace() ? float4( 0.654902, 0.3411765, 0.8509804, 0 ) : float4( 0.3864295, 0.0953075, 0.6938719, 0 );
					float3 ifLocalVar40_g240745 = 0;
					if( IsShaderType2402 == 3.0 )
					ifLocalVar40_g240745 = color2391.rgb;
					float4 color2412 = IsGammaSpace() ? float4( 0.8117647, 0.3490196, 0.2627451, 0 ) : float4( 0.6239604, 0.09989873, 0.05612849, 0 );
					float3 ifLocalVar40_g240746 = 0;
					if( IsShaderType2402 == 4.0 )
					ifLocalVar40_g240746 = color2412.rgb;
					half3 Final_Debug2386 = ( ifLocalVar40_g240743 + ifLocalVar40_g240744 + ifLocalVar40_g240745 + ifLocalVar40_g240746 );
					float temp_output_7_0_g251370 = TVE_DEBUG_Min;
					float3 temp_cast_8 = (temp_output_7_0_g251370).xxx;
					float3 temp_output_9_0_g251370 = ( Final_Debug2386 - temp_cast_8 );
					...
					float4 ase_positionCS57_g251362 = IN.ase_texcoord6;
					...
					half4 Dummy130_g240758 = ( _MainCategory + _MainEnd + ( _MainSampleMode + _MainCoordMode + _MainCoordValue ) );
					float temp_output_14_0_g251315 = Dummy130_g240758.x;
					...
					half4 Local_Coords180_g240758 = _main_coord_value;
					float4 Coords444_g251346 = Local_Coords180_g240758;
					TVEModelData Data16_g240717 =(TVEModelData)(TVEModelData)0;
					float In_Dummy16_g240717 = 0.0;
					float3 vertexToFrag73_g240709 = IN.ase_texcoord7.xyz;
					float3 PositionWS122_g240709 = vertexToFrag73_g240709;
					float3 In_PositionWS16_g240717 = PositionWS122_g240709;
					float3 vertexToFrag76_g240709 = IN.ase_texcoord8.xyz;
					float3 PivotWS121_g240709 = vertexToFrag76_g240709;
					#ifdef TVE_SCOPE_DYNAMIC
					float3 staticSwitch204_g240709 = ( PositionWS122_g240709 - PivotWS121_g240709 );
					#else
					...
					half3 NormalWS95_g240709 = normalizedWorldNormal;
					float3 In_NormalWS16_g240717 = NormalWS95_g240709;
					half3 TangentWS136_g240709 = TangentWS;
					float3 In_TangentWS16_g240717 = TangentWS136_g240709;
					half3 BiangentWS421_g240709 = BitangentWS;
					float3 In_BitangentWS16_g240717 = BiangentWS421_g240709;
					half3 NormalWS427_g240709 = NormalWS95_g240709;
					half3 localComputeTriplanarWeights427_g240709 = ComputeTriplanarWeights( NormalWS427_g240709 );
					half3 TriplanarWeights429_g240709 = localComputeTriplanarWeights427_g240709;
					...
					half3 ViewDirWS169_g240709 = normalizeResult296_g240709;
					float3 In_ViewDirWS16_g240717 = ViewDirWS169_g240709;
					float4 appendResult397_g240709 = (float4(IN.ase_texcoord9.xy , IN.ase_texcoord9.zw));
					float4 CoordsData398_g240709 = appendResult397_g240709;
					float4 In_CoordsData16_g240717 = CoordsData398_g240709;
					half4 VertexMasks171_g240709 = IN.ase_color;
					float4 In_VertexData16_g240717 = VertexMasks171_g240709;
					float temp_output_17_0_g240721 = _ObjectPhaseMode;
					float Option70_g240721 = temp_output_17_0_g240721;
					float4 temp_output_3_0_g240721 = IN.ase_color;
					float4 Channel70_g240721 = temp_output_3_0_g240721;
					float localSwitchChannel470_g240721 = SwitchChannel4( Option70_g240721 , Channel70_g240721 );
					half Phase_Value372_g240709 = localSwitchChannel470_g240721;
					float3 break319_g240709 = PivotWO133_g240709;
					...
					float4 In_PhaseData16_g240717 = Phase_Data176_g240709;
					BuildModelFragData( Data16_g240717 , In_Dummy16_g240717 , In_PositionWS16_g240717 , In_PositionWO16_g240717 , In_PivotWS16_g240717 , In_PivotWO16_g240717 , In_NormalWS16_g240717 , In_TangentWS16_g240717 , In_BitangentWS16_g240717 , In_TriplanarWeights16_g240717 , In_ViewDirWS16_g240717 , In_CoordsData16_g240717 , In_VertexData16_g240717 , In_PhaseData16_g240717 );
					TVEModelData Data15_g251330 =(TVEModelData)Data16_g240717;
					...
					float4 Model_CoordsData324_g240758 = Out_CoordsData15_g251330;
					float4 MeshCoords444_g251346 = Model_CoordsData324_g240758;
					...
					float4 Coords315_g251346 = Local_Coords180_g240758;
					float3 Model_PositionWO222_g240758 = Out_PositionWO15_g251330;
					float3 PositionWS315_g251346 = Model_PositionWO222_g240758;
					...
					half3 Model_NormalWS226_g240758 = Out_NormalWS15_g251330;
					float3 temp_output_449_0_g251346 = Model_NormalWS226_g240758;
					float4 In_MaskK431_g251346 = float4( temp_output_449_0_g251346 , 0.0 );
					half3 Model_TangentWS366_g240758 = Out_TangentWS15_g251330;
					float3 temp_output_450_0_g251346 = Model_TangentWS366_g240758;
					float4 In_MaskL431_g251346 = float4( temp_output_450_0_g251346 , 0.0 );
					half3 Model_BitangentWS367_g240758 = Out_BitangentWS15_g251330;
					float3 temp_output_451_0_g251346 = Model_BitangentWS367_g240758;
					float4 In_MaskM431_g251346 = float4( temp_output_451_0_g251346 , 0.0 );
					half3 Model_TriplanarWeights368_g240758 = Out_TriplanarWeights15_g251330;
					float3 temp_output_445_0_g251346 = Model_TriplanarWeights368_g240758;
					...
					float4 temp_output_407_277_g240758 = localSampleCoord276_g251356;
					...
					float4 temp_output_407_278_g240758 = localSampleCoord502_g251356;
					...
					float4 temp_output_407_0_g240758 = localSamplePlanar2D496_g251356;
					...
					float4 temp_output_407_201_g240758 = localSamplePlanar3D490_g251356;
					...
					float4 temp_output_407_202_g240758 = localSampleStochastic2D498_g251356;
					...
					float4 temp_output_407_203_g240758 = localSampleStochastic3D500_g251356;
					#if defined( TVE_MAIN_SAMPLE_MAIN_UV )
					float4 staticSwitch184_g240758 = temp_output_407_277_g240758;
					#elif defined( TVE_MAIN_SAMPLE_EXTRA_UV )
					float4 staticSwitch184_g240758 = temp_output_407_278_g240758;
					#elif defined( TVE_MAIN_SAMPLE_PLANAR_2D )
					float4 staticSwitch184_g240758 = temp_output_407_0_g240758;
					#elif defined( TVE_MAIN_SAMPLE_PLANAR_3D )
					float4 staticSwitch184_g240758 = temp_output_407_201_g240758;
					#elif defined( TVE_MAIN_SAMPLE_STOCHASTIC_2D )
					float4 staticSwitch184_g240758 = temp_output_407_202_g240758;
					#elif defined( TVE_MAIN_SAMPLE_STOCHASTIC_3D )
					float4 staticSwitch184_g240758 = temp_output_407_203_g240758;
					#else
					float4 staticSwitch184_g240758 = temp_output_407_277_g240758;
					#endif
					half4 Local_AlbedoSample185_g240758 = staticSwitch184_g240758;
					float3 lerpResult53_g240758 = lerp( float3( 1,1,1 ) , (Local_AlbedoSample185_g240758).xyz , _MainAlbedoValue);
					half3 Local_AlbedoRGB107_g240758 = lerpResult53_g240758;
					...
					float4 temp_output_405_277_g240758 = localSampleCoord276_g251354;
					...
					float4 temp_output_405_278_g240758 = localSampleCoord502_g251354;
					...
					float4 temp_output_405_0_g240758 = localSamplePlanar2D496_g251354;
					...
					float4 temp_output_405_201_g240758 = localSamplePlanar3D490_g251354;
					...
					float4 temp_output_405_202_g240758 = localSampleStochastic2D498_g251354;
					...
					float4 temp_output_405_203_g240758 = localSampleStochastic3D500_g251354;
					#if defined( TVE_MAIN_SAMPLE_MAIN_UV )
					float4 staticSwitch198_g240758 = temp_output_405_277_g240758;
					#elif defined( TVE_MAIN_SAMPLE_EXTRA_UV )
					float4 staticSwitch198_g240758 = temp_output_405_278_g240758;
					#elif defined( TVE_MAIN_SAMPLE_PLANAR_2D )
					float4 staticSwitch198_g240758 = temp_output_405_0_g240758;
					#elif defined( TVE_MAIN_SAMPLE_PLANAR_3D )
					float4 staticSwitch198_g240758 = temp_output_405_201_g240758;
					#elif defined( TVE_MAIN_SAMPLE_STOCHASTIC_2D )
					float4 staticSwitch198_g240758 = temp_output_405_202_g240758;
					#elif defined( TVE_MAIN_SAMPLE_STOCHASTIC_3D )
					float4 staticSwitch198_g240758 = temp_output_405_203_g240758;
					#else
					float4 staticSwitch198_g240758 = temp_output_405_277_g240758;
					#endif
					half4 Local_ShaderSample199_g240758 = staticSwitch198_g240758;
					float temp_output_209_0_g240758 = (Local_ShaderSample199_g240758).y;
					float temp_output_7_0_g251323 = _MainOcclusionRemap.x;
					float temp_output_9_0_g251323 = ( temp_output_209_0_g240758 - temp_output_7_0_g251323 );
					float lerpResult23_g240758 = lerp( 1.0 , saturate( ( temp_output_9_0_g251323 * _MainOcclusionRemap.z ) ) , _MainOcclusionValue);
					half Local_Occlusion313_g240758 = lerpResult23_g240758;
					float temp_output_213_0_g240758 = (Local_ShaderSample199_g240758).w;
					float temp_output_7_0_g251327 = _MainSmoothnessRemap.x;
					float temp_output_9_0_g251327 = ( temp_output_213_0_g240758 - temp_output_7_0_g251327 );
					half Local_Smoothness317_g240758 = ( saturate( ( temp_output_9_0_g251327 * _MainSmoothnessRemap.z ) ) * _MainSmoothnessValue );
					float4 appendResult73_g240758 = (float4(( (Local_ShaderSample199_g240758).x * _MainMetallicValue ) , Local_Occlusion313_g240758 , (Local_ShaderSample199_g240758).z , Local_Smoothness317_g240758));
					half4 Local_Masks109_g240758 = appendResult73_g240758;
					float temp_output_135_0_g240758 = (Local_Masks109_g240758).z;
					float temp_output_7_0_g251322 = _MainMultiRemap.x;
					float temp_output_9_0_g251322 = ( temp_output_135_0_g240758 - temp_output_7_0_g251322 );
					float temp_output_42_0_g240758 = saturate( ( temp_output_9_0_g251322 * _MainMultiRemap.z ) );
					half Local_MultiMask78_g240758 = temp_output_42_0_g240758;
					float lerpResult58_g240758 = lerp( 1.0 , Local_MultiMask78_g240758 , _MainColorMode);
					float4 lerpResult62_g240758 = lerp( _MainColorTwo , _MainColor , lerpResult58_g240758);
					half3 Local_ColorRGB93_g240758 = (lerpResult62_g240758).rgb;
					half3 Local_Albedo139_g240758 = ( Local_AlbedoRGB107_g240758 * Local_ColorRGB93_g240758 );
					float3 temp_output_4_0_g251315 = Local_Albedo139_g240758;
					float3 In_Albedo3_g251315 = temp_output_4_0_g251315;
					float3 temp_output_44_0_g251315 = Local_Albedo139_g240758;
					...
					float2 temp_output_406_394_g240758 = Normal276_g251355;
					...
					float2 temp_output_406_397_g240758 = Normal502_g251355;
					...
					float2 temp_output_406_375_g240758 = (worldToTangentDir408_g251355).xy;
					...
					float2 temp_output_406_353_g240758 = (worldToTangentDir399_g251355).xy;
					...
					float2 temp_output_406_391_g240758 = (worldToTangentDir411_g251355).xy;
					...
					float2 temp_output_406_390_g240758 = (worldToTangentDir403_g251355).xy;
					#if defined( TVE_MAIN_SAMPLE_MAIN_UV )
					float2 staticSwitch193_g240758 = temp_output_406_394_g240758;
					#elif defined( TVE_MAIN_SAMPLE_EXTRA_UV )
					float2 staticSwitch193_g240758 = temp_output_406_397_g240758;
					#elif defined( TVE_MAIN_SAMPLE_PLANAR_2D )
					float2 staticSwitch193_g240758 = temp_output_406_375_g240758;
					#elif defined( TVE_MAIN_SAMPLE_PLANAR_3D )
					float2 staticSwitch193_g240758 = temp_output_406_353_g240758;
					#elif defined( TVE_MAIN_SAMPLE_STOCHASTIC_2D )
					float2 staticSwitch193_g240758 = temp_output_406_391_g240758;
					#elif defined( TVE_MAIN_SAMPLE_STOCHASTIC_3D )
					float2 staticSwitch193_g240758 = temp_output_406_390_g240758;
					#else
					float2 staticSwitch193_g240758 = temp_output_406_394_g240758;
					#endif
					half2 Local_NormaSample191_g240758 = staticSwitch193_g240758;
					half2 Local_NormalTS108_g240758 = ( Local_NormaSample191_g240758 * _MainNormalValue );
					float2 In_NormalTS3_g251315 = Local_NormalTS108_g240758;
					float3 appendResult68_g251329 = (float3(Local_NormalTS108_g240758 , 1.0));
					...
					half3 Local_NormalWS250_g240758 = worldNormal74_g251329;
					float3 In_NormalWS3_g251315 = Local_NormalWS250_g240758;
					float4 In_Shader3_g251315 = Local_Masks109_g240758;
					float4 In_Feature3_g251315 = half4( 1, 1, 1, 1 );
					float4 In_Season3_g251315 = half4( 1, 1, 1, 1 );
					float4 In_Emissive3_g251315 = half4( 1, 1, 1, 1 );
					float3 temp_output_3_0_g251326 = Local_Albedo139_g240758;
					float dotResult20_g251326 = dot( temp_output_3_0_g251326 , float3( 0.2126, 0.7152, 0.0722 ) );
					half Local_Grayscale110_g240758 = dotResult20_g251326;
					float temp_output_12_0_g251315 = Local_Grayscale110_g240758;
					float In_Grayscale3_g251315 = temp_output_12_0_g251315;
					float clampResult27_g251328 = clamp( saturate( ( Local_Grayscale110_g240758 * 5.0 ) ) , 0.2 , 1.0 );
					half Local_Luminosity145_g240758 = clampResult27_g251328;
					float temp_output_16_0_g251315 = Local_Luminosity145_g240758;
					float In_Luminosity3_g251315 = temp_output_16_0_g251315;
					float In_MultiMask3_g251315 = Local_MultiMask78_g240758;
					float temp_output_187_0_g240758 = (Local_AlbedoSample185_g240758).w;
					#ifdef TVE_CLIPPING
					float staticSwitch236_g240758 = ( temp_output_187_0_g240758 - _MainAlphaClipValue );
					#else
					float staticSwitch236_g240758 = temp_output_187_0_g240758;
					#endif
					half Local_AlphaClip111_g240758 = staticSwitch236_g240758;
					float In_AlphaClip3_g251315 = Local_AlphaClip111_g240758;
					half Local_AlphaFade246_g240758 = (lerpResult62_g240758).a;
					float In_AlphaFade3_g251315 = Local_AlphaFade246_g240758;
		...
		Pass
		{
			...
			CGPROGRAM
				...
				v2f VertexFunction (appdata v  ) {
					...
					float3 vertexPos57_g251362 = v.vertex.xyz;
					float4 ase_positionCS57_g251362 = UnityObjectToClipPos( vertexPos57_g251362 );
					o.ase_texcoord4 = ase_positionCS57_g251362;
					o.ase_texcoord5.xyz = vertexToFrag73_g240709;
					o.ase_texcoord6.xyz = vertexToFrag76_g240709;
				...
				)
				{
					...
					float temp_output_65_0_g251362 = ( 1.0 - saturate( dotResult61_g251362 ) );
					float Shading_Fresnel59_g251362 = (( 1.0 - ( temp_output_65_0_g251362 * temp_output_65_0_g251362 ) )*0.3 + 0.7);
					float4 ase_positionCS57_g251362 = IN.ase_texcoord4;
					float depthLinearEye57_g251362 = LinearEyeDepth( ase_positionCS57_g251362.z / ase_positionCS57_g251362.w );
					float temp_output_69_0_g251362 = saturate(  (0.0 + ( depthLinearEye57_g251362 - 300.0 ) * ( 1.0 - 0.0 ) / ( 0.0 - 300.0 ) ) );
					float Shading_Distance58_g251362 = (( temp_output_69_0_g251362 * temp_output_69_0_g251362 )*0.5 + 0.5);
					float lerpResult84_g251362 = lerp( 1.0 , Shading_Fresnel59_g251362 , ( Shading_Distance58_g251362 * TVE_DEBUG_Shading ));
					...
					TVEModelData Data16_g240717 =(TVEModelData)(TVEModelData)0;
					float In_Dummy16_g240717 = 0.0;
					float3 vertexToFrag73_g240709 = IN.ase_texcoord5.xyz;
					float3 PositionWS122_g240709 = vertexToFrag73_g240709;
					float3 In_PositionWS16_g240717 = PositionWS122_g240709;
					float3 vertexToFrag76_g240709 = IN.ase_texcoord6.xyz;
					float3 PivotWS121_g240709 = vertexToFrag76_g240709;
					#ifdef TVE_SCOPE_DYNAMIC
					float3 staticSwitch204_g240709 = ( PositionWS122_g240709 - PivotWS121_g240709 );
					#else
					...
					half3 ViewDirWS169_g240709 = normalizeResult296_g240709;
					float3 In_ViewDirWS16_g240717 = ViewDirWS169_g240709;
					float4 appendResult397_g240709 = (float4(IN.ase_texcoord7.xy , IN.ase_texcoord7.zw));
					float4 CoordsData398_g240709 = appendResult397_g240709;
					float4 In_CoordsData16_g240717 = CoordsData398_g240709;
					half4 VertexMasks171_g240709 = IN.ase_color;
					float4 In_VertexData16_g240717 = VertexMasks171_g240709;
		...
		Pass
		{
			...
			CGPROGRAM
				...
				v2f VertexFunction( appdata v  )
				{
					...
					half3 ViewDirWS169_g240709 = normalizeResult296_g240709;
					float3 In_ViewDirWS16_g240719 = ViewDirWS169_g240709;
					float4 appendResult397_g240709 = (float4(v.ase_texcoord.xy , v.ase_texcoord2.xy));
					float4 CoordsData398_g240709 = appendResult397_g240709;
					float4 In_CoordsData16_g240719 = CoordsData398_g240709;
					half4 VertexMasks171_g240709 = v.ase_color;
					float4 In_VertexData16_g240719 = VertexMasks171_g240709;
...
/*ASEBEGIN
Version=19908
Node;AmplifyShaderEditor.GetLocalVarNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;2423;-5376,-5760;Inherit;False;2422;Model Frag;1;0;OBJECT;;False;1;OBJECT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;2424;-5824,-5760;Half;False;Model Vert;-1;True;1;0;OBJECT;;False;1;OBJECT;0
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;2425;-5120,-5760;Inherit;False;Block Global;46;;240632;212e17d4006dc88449d56ce0340cb5ff;32,308,1,560,1,276,1,285,1,402,1,385,1,283,1,282,1,396,1,417,1,484,0,485,0,486,0,487,0,561,0,482,0,488,0,483,0,315,1,598,0,311,1,578,0,317,1,603,0,604,0,607,0,421,1,321,1,398,1,413,0,557,1,404,1;1;206;OBJECT;0,0,0,0;False;1;OBJECT;151
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;2401;-640,-6016;Inherit;False;Property;_IsShaderType;_IsShaderType;45;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;2426;-4800,-5760;Half;False;Global Data;-1;True;1;0;OBJECT;;False;1;OBJECT;0
Node;AmplifyShaderEditor.GetLocalVarNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;2427;-4352,-5760;Inherit;False;2424;Model Vert;1;0;OBJECT;;False;1;OBJECT;0
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;2421;-6144,-5760;Inherit;False;Block Model;7;;240709;7ad7765e793a6714babedee0033c36e9;18,404,1,437,1,431,1,240,1,290,1,289,1,291,1,181,0,183,0,185,0,184,0,188,0,190,0,192,0,189,0,300,0,419,0,193,0;11;102;FLOAT3;0,0,0;False;163;FLOAT3;0,0,0;False;186;FLOAT3;0,0,0;False;187;FLOAT3;0,0,0;False;166;FLOAT3;0,0,0;False;164;FLOAT3;0,0,0;False;301;FLOAT3;0,0,0;False;418;FLOAT3;0,0,0;False;167;FLOAT4;0,0,0,0;False;172;FLOAT4;0,0,0,0;False;175;FLOAT4;0,0,0,0;False;2;OBJECT;128;OBJECT;314
Node;AmplifyShaderEditor.RegisterLocalVarNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;2402;-384,-6016;Half;False;IsShaderType;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;2428;-4096,-5760;Inherit;False;Block Pivots Sub;-1;;240729;186f08b1bbe15894d9c677d50398679b;0;1;146;OBJECT;0,0,0,0;False;1;OBJECT;128
Node;AmplifyShaderEditor.GetLocalVarNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;2429;-4096,-5632;Inherit;False;2426;Global Data;1;0;OBJECT;;False;1;OBJECT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;2422;-5824,-5696;Half;False;Model Frag;-1;True;1;0;OBJECT;;False;1;OBJECT;0
Node;AmplifyShaderEditor.ColorNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;2395;-640,-5760;Inherit;False;Constant;_Color13;Color 0;10;0;Create;True;0;0;0;False;0;False;0.9254902,0.7960784,0.4156863,1;0,0,0,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.ColorNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;2398;-640,-5504;Inherit;False;Constant;_Color14;Color 10;10;0;Create;True;0;0;0;False;0;False;0.6196079,0.7686275,0.1490196,0;0,0,0,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.GetLocalVarNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;2407;-384,-5632;Inherit;False;2402;IsShaderType;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;2409;-384,-5376;Inherit;False;2402;IsShaderType;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;2410;-384,-5120;Inherit;False;2402;IsShaderType;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;2413;-384,-4864;Inherit;False;2402;IsShaderType;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;2412;-640,-4992;Inherit;False;Constant;_Color21;Color 4;10;0;Create;True;0;0;0;False;0;False;0.8117647,0.3490196,0.2627451,0;0,0,0,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;2430;-3712,-5760;Inherit;False;Block Blanket Conform;105;;240733;3ce1684c4351aeb42b79a955aa483301;2,389,0,377,1;2;146;OBJECT;0,0,0,0;False;186;OBJECT;0,0,0,0;False;1;OBJECT;128
Node;AmplifyShaderEditor.GetLocalVarNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;2375;-2176,-5760;Inherit;False;2422;Model Frag;1;0;OBJECT;;False;1;OBJECT;0
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;2406;-128,-5760;Inherit;False;Tool Branch;-1;;240743;d4048633f69bd3f44beb2beef049f6d2;0;3;39;FLOAT3;0,0,0;False;34;FLOAT;0;False;36;FLOAT;1;False;1;FLOAT3;0
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;2408;-128,-5504;Inherit;False;Tool Branch;-1;;240744;d4048633f69bd3f44beb2beef049f6d2;0;3;39;FLOAT3;0,0,0;False;34;FLOAT;0;False;36;FLOAT;2;False;1;FLOAT3;0
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;2411;-128,-5248;Inherit;False;Tool Branch;-1;;240745;d4048633f69bd3f44beb2beef049f6d2;0;3;39;FLOAT3;0,0,0;False;34;FLOAT;0;False;36;FLOAT;3;False;1;FLOAT3;0
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;2414;-128,-4992;Inherit;False;Tool Branch;-1;;240746;d4048633f69bd3f44beb2beef049f6d2;0;3;39;FLOAT3;0,0,0;False;34;FLOAT;0;False;36;FLOAT;4;False;1;FLOAT3;0
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;2434;-3328,-5760;Inherit;False;Block Transform;-1;;240747;5ac6202bdddd8b34a85c261af6b8de8b;0;1;146;OBJECT;0,0,0,0;False;1;OBJECT;128
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;2376;-1920,-5760;Inherit;False;Block Main;20;;240758;b04cfed9a7b4c0841afdb49a38c282c5;12,65,1,136,1,41,1,133,1,40,1,329,1,344,0,347,0,342,0,345,0,346,0,343,0;1;225;OBJECT;0,0,0,0;False;1;OBJECT;106
...
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;2431;-2944,-5760;Inherit;False;Block Pivots Add;-1;;251357;016babe9e3e643242aa4d123a988150c;0;1;146;OBJECT;0,0,0,0;False;1;OBJECT;128
...
Node;AmplifyShaderEditor.RegisterLocalVarNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;2416;-1600,-5760;Half;False;Visual Data;-1;True;1;0;OBJECT;0;False;1;OBJECT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;2432;-2624,-5760;Half;False;Model Data;-1;True;1;0;OBJECT;;False;1;OBJECT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;2417;1920,-5632;Inherit;False;2432;Model Data;1;0;OBJECT;;False;1;OBJECT;0
...
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;2383;2560,-5888;Inherit;False;Base Compile;-1;;251361;e67c8238031dbf04ab79a5d4d63d1b4f;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;2433;2176,-5760;Inherit;False;Tool Debug Color;0;;251362;d992d3ed4a7539141ba053d3e0c12277;0;3;80;FLOAT3;0,0,0;False;106;OBJECT;0,0,0;False;107;OBJECT;0,0,0;False;5;FLOAT;114;FLOAT3;0;FLOAT3;113;FLOAT3;148;FLOAT4;149
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;2435;2560,-5700;Float;False;False;-1;3;AmplifyShaderEditor.MaterialInspector;0;1;New Amplify Shader;28cd5599e02859647ae1798e4fcaef6c;True;SceneSelectionPass;0;6;SceneSelectionPass;0;False;True;0;1;False;;0;False;;0;1;False;;0;False;;True;0;False;;0;False;;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;False;False;True;3;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;DisableBatching=False=DisableBatching;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;False;;False;False;False;True;1;LightMode=SceneSelectionPass;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;2436;2560,-5760;Float;False;False;-1;3;AmplifyShaderEditor.MaterialInspector;0;1;New Amplify Shader;28cd5599e02859647ae1798e4fcaef6c;True;ScenePickingPass;0;7;ScenePickingPass;1;False;True;0;1;False;;0;False;;0;1;False;;0;False;;True;0;False;;0;False;;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;False;False;True;3;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;DisableBatching=False=DisableBatching;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;False;;False;False;False;True;1;LightMode=ScenePickingPass;False;False;0;;0;0;Standard;0;False;0
WireConnection;2424;0;2421;128
WireConnection;2425;206;2423;0
WireConnection;2426;0;2425;151
WireConnection;2402;0;2401;0
WireConnection;2428;146;2427;0
WireConnection;2422;0;2421;314
WireConnection;2430;146;2428;128
WireConnection;2430;186;2429;0
...
WireConnection;2434;146;2430;128
...
WireConnection;2431;146;2434;128
WireConnection;2386;0;2400;0
WireConnection;2416;0;2376;106
WireConnection;2432;0;2431;128
...
WireConnection;2433;80;2380;0
WireConnection;2433;106;2381;0
WireConnection;2433;107;2417;0
WireConnection;2354;0;2433;114
WireConnection;2354;4;2433;114
WireConnection;2354;5;2433;114
WireConnection;2354;2;2433;0
WireConnection;2354;15;2433;113
WireConnection;2354;16;2433;148
WireConnection;2354;17;2433;149
ASEEND*/
//CHKSM=5A7DA5DD21C01819ED30892FE15B98A465EB9B30